...
<div class="col-md-12">
  <div class="card shadow-sm">
    ...
    <div class="card-body">
<?php } ?>
<form name="flaporan_penelitianadd" id="flaporan_penelitianadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
...
<?php } else { ?>
<table id="tbl_laporan_penelitianadd" class="<?= $Page->TableClass ?>"><!-- table* -->
<?php } ?>
...
<span id="el_laporan_penelitian_Id_Kelompok">
    <select
        ...
        data-select2-id="flaporan_penelitianadd_x_Id_Kelompok"
        <?php } ?>
...
<?php if (!$Page->Id_Kelompok->IsNativeSelect) { ?>
<script>
loadjs.ready("flaporan_penelitianadd", function() {
    var options = { name: "x_Id_Kelompok", selectId: "flaporan_penelitianadd_x_Id_Kelompok" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (flaporan_penelitianadd.lists.Id_Kelompok?.lookupOptions.length) {
        options.data = { id: "x_Id_Kelompok", form: "flaporan_penelitianadd" };
    } else {
        options.ajax = { id: "x_Id_Kelompok", form: "flaporan_penelitianadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<input type="hidden" name="fa_x_Surat_Pernyataan_Kesediaan_Anggota" id= "fa_x_Surat_Pernyataan_Kesediaan_Anggota" value="0">
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="flaporan_penelitianadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="flaporan_penelitianadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
...
<script>
loadjs.ready("head", function() { $("#flaporan_penelitianadd:first *:input[type!=hidden]:first").focus(),$("input").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()}),$("select").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()}),$("radio").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()})});
</script>
<?php } ?>
<script>
