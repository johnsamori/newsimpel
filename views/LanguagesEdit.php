...
<?php } else { ?>
<table id="tbl_languagesedit" class="<?= $Page->TableClass ?>"><!-- table* -->
<?php } ?>
...
<?php } else { ?>
    <tr id="r_Language_Code"<?= $Page->Language_Code->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_languages_Language_Code"><?= $Page->Language_Code->caption() ?><?= $Page->Language_Code->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } else { ?>
    <tr id="r_Language_Name"<?= $Page->Language_Name->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_languages_Language_Name"><?= $Page->Language_Name->caption() ?><?= $Page->Language_Name->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } else { ?>
    <tr id="r__Default"<?= $Page->_Default->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_languages__Default"><?= $Page->_Default->caption() ?><?= $Page->_Default->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } else { ?>
    <tr id="r_Site_Logo"<?= $Page->Site_Logo->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_languages_Site_Logo"><?= $Page->Site_Logo->caption() ?><?= $Page->Site_Logo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } else { ?>
    <tr id="r_Site_Title"<?= $Page->Site_Title->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_languages_Site_Title"><?= $Page->Site_Title->caption() ?><?= $Page->Site_Title->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } else { ?>
    <tr id="r_Default_Thousands_Separator"<?= $Page->Default_Thousands_Separator->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_languages_Default_Thousands_Separator"><?= $Page->Default_Thousands_Separator->caption() ?><?= $Page->Default_Thousands_Separator->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } else { ?>
    <tr id="r_Default_Decimal_Point"<?= $Page->Default_Decimal_Point->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_languages_Default_Decimal_Point"><?= $Page->Default_Decimal_Point->caption() ?><?= $Page->Default_Decimal_Point->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } else { ?>
    <tr id="r_Default_Currency_Symbol"<?= $Page->Default_Currency_Symbol->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_languages_Default_Currency_Symbol"><?= $Page->Default_Currency_Symbol->caption() ?><?= $Page->Default_Currency_Symbol->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } else { ?>
    <tr id="r_Default_Money_Thousands_Separator"<?= $Page->Default_Money_Thousands_Separator->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_languages_Default_Money_Thousands_Separator"><?= $Page->Default_Money_Thousands_Separator->caption() ?><?= $Page->Default_Money_Thousands_Separator->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } else { ?>
    <tr id="r_Default_Money_Decimal_Point"<?= $Page->Default_Money_Decimal_Point->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_languages_Default_Money_Decimal_Point"><?= $Page->Default_Money_Decimal_Point->caption() ?><?= $Page->Default_Money_Decimal_Point->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<textarea data-table="languages" data-field="x_Terms_And_Condition_Text" name="x_Terms_And_Condition_Text" id="x_Terms_And_Condition_Text" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->Terms_And_Condition_Text->getPlaceHolder()) ?>"<?= $Page->Terms_And_Condition_Text->editAttributes() ?> aria-describedby="x_Terms_And_Condition_Text_help"><?= $Page->Terms_And_Condition_Text->EditValue ?></textarea>
...
<?php } else { ?>
    <tr id="r_Terms_And_Condition_Text"<?= $Page->Terms_And_Condition_Text->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_languages_Terms_And_Condition_Text"><?= $Page->Terms_And_Condition_Text->caption() ?><?= $Page->Terms_And_Condition_Text->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
        <td<?= $Page->Terms_And_Condition_Text->cellAttributes() ?>>
<span id="el_languages_Terms_And_Condition_Text">
<textarea data-table="languages" data-field="x_Terms_And_Condition_Text" name="x_Terms_And_Condition_Text" id="x_Terms_And_Condition_Text" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->Terms_And_Condition_Text->getPlaceHolder()) ?>"<?= $Page->Terms_And_Condition_Text->editAttributes() ?> aria-describedby="x_Terms_And_Condition_Text_help"><?= $Page->Terms_And_Condition_Text->EditValue ?></textarea>
<?= $Page->Terms_And_Condition_Text->getCustomMessage() ?>
<div class="invalid-feedback"><?= $Page->Terms_And_Condition_Text->getErrorMessage() ?></div>
...
<textarea data-table="languages" data-field="x_Announcement_Text" name="x_Announcement_Text" id="x_Announcement_Text" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->Announcement_Text->getPlaceHolder()) ?>"<?= $Page->Announcement_Text->editAttributes() ?> aria-describedby="x_Announcement_Text_help"><?= $Page->Announcement_Text->EditValue ?></textarea>
...
<?php } else { ?>
    <tr id="r_Announcement_Text"<?= $Page->Announcement_Text->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_languages_Announcement_Text"><?= $Page->Announcement_Text->caption() ?><?= $Page->Announcement_Text->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
        <td<?= $Page->Announcement_Text->cellAttributes() ?>>
<span id="el_languages_Announcement_Text">
<textarea data-table="languages" data-field="x_Announcement_Text" name="x_Announcement_Text" id="x_Announcement_Text" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->Announcement_Text->getPlaceHolder()) ?>"<?= $Page->Announcement_Text->editAttributes() ?> aria-describedby="x_Announcement_Text_help"><?= $Page->Announcement_Text->EditValue ?></textarea>
<?= $Page->Announcement_Text->getCustomMessage() ?>
<div class="invalid-feedback"><?= $Page->Announcement_Text->getErrorMessage() ?></div>
...
<textarea data-table="languages" data-field="x_About_Text" name="x_About_Text" id="x_About_Text" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->About_Text->getPlaceHolder()) ?>"<?= $Page->About_Text->editAttributes() ?> aria-describedby="x_About_Text_help"><?= $Page->About_Text->EditValue ?></textarea>
...
<?php } else { ?>
    <tr id="r_About_Text"<?= $Page->About_Text->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_languages_About_Text"><?= $Page->About_Text->caption() ?><?= $Page->About_Text->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
        <td<?= $Page->About_Text->cellAttributes() ?>>
<span id="el_languages_About_Text">
<textarea data-table="languages" data-field="x_About_Text" name="x_About_Text" id="x_About_Text" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->About_Text->getPlaceHolder()) ?>"<?= $Page->About_Text->editAttributes() ?> aria-describedby="x_About_Text_help"><?= $Page->About_Text->EditValue ?></textarea>
<?= $Page->About_Text->getCustomMessage() ?>
<div class="invalid-feedback"><?= $Page->About_Text->getErrorMessage() ?></div>
