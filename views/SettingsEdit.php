...
<div class="col-md-12">
  <div class="card shadow-sm">
    ...
    <div class="card-body">
<?php } ?>
<form name="fsettingsedit" id="fsettingsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<script>
...
<?php } else { ?>
<table id="tbl_settingsedit" class="<?= $Page->TableClass ?>"><!-- table* -->
<?php } ?>
...
<?php } else { ?>
    <tr id="r_Option_ID"<?= $Page->Option_ID->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_settings_Option_ID"><?= $Page->Option_ID->caption() ?><?= $Page->Option_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } else { ?>
    <tr id="r_Option_Default"<?= $Page->Option_Default->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_settings_Option_Default"><?= $Page->Option_Default->caption() ?><?= $Page->Option_Default->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } else { ?>
    <tr id="r_Show_Announcement"<?= $Page->Show_Announcement->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_settings_Show_Announcement"><?= $Page->Show_Announcement->caption() ?><?= $Page->Show_Announcement->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } else { ?>
    <tr id="r_Use_Announcement_Table"<?= $Page->Use_Announcement_Table->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_settings_Use_Announcement_Table"><?= $Page->Use_Announcement_Table->caption() ?><?= $Page->Use_Announcement_Table->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } else { ?>
    <tr id="r_Maintenance_Mode"<?= $Page->Maintenance_Mode->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_settings_Maintenance_Mode"><?= $Page->Maintenance_Mode->caption() ?><?= $Page->Maintenance_Mode->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
loadjs.ready(["fsettingsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fsettingsedit", "x_Maintenance_Finish_DateTime", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
    <tr id="r_Maintenance_Finish_DateTime"<?= $Page->Maintenance_Finish_DateTime->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_settings_Maintenance_Finish_DateTime"><?= $Page->Maintenance_Finish_DateTime->caption() ?><?= $Page->Maintenance_Finish_DateTime->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } else { ?>
    <tr id="r_Auto_Normal_After_Maintenance"<?= $Page->Auto_Normal_After_Maintenance->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_settings_Auto_Normal_After_Maintenance"><?= $Page->Auto_Normal_After_Maintenance->caption() ?><?= $Page->Auto_Normal_After_Maintenance->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
