...
<div class="col-md-12">
  <div class="card shadow-sm">
    ...
    <div class="card-body">
<?php } ?>
<form name="fproposal_pengabdianedit" id="fproposal_pengabdianedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { proposal_pengabdian: currentTable } });
var currentPageID = ew.PAGE_ID = "edit";
var currentForm;
var fproposal_pengabdianedit;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fproposal_pengabdianedit")
        .setPageId("edit")
...
<?php } else { ?>
<table id="tbl_proposal_pengabdianedit" class="<?= $Page->TableClass ?>"><!-- table* -->
<?php } ?>
<?php if ($Page->Id_kelompok->Visible) { // Id_kelompok ?>
<?php if ($Page->IsMobileOrModal) { ?>
    <div id="r_Id_kelompok"<?= $Page->Id_kelompok->rowAttributes() ?>>
        <label id="elh_proposal_pengabdian_Id_kelompok" for="x_Id_kelompok" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Id_kelompok->caption() ?><?= $Page->Id_kelompok->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->Id_kelompok->cellAttributes() ?>>
<span id="el_proposal_pengabdian_Id_kelompok">
    <select
        id="x_Id_kelompok"
        name="x_Id_kelompok"
        class="form-select ew-select<?= $Page->Id_kelompok->isInvalidClass() ?>"
        <?php if (!$Page->Id_kelompok->IsNativeSelect) { ?>
        data-select2-id="fproposal_pengabdianedit_x_Id_kelompok"
        <?php } ?>
        data-table="proposal_pengabdian"
...
<?php if (!$Page->Id_kelompok->IsNativeSelect) { ?>
<script>
loadjs.ready("fproposal_pengabdianedit", function() {
    var options = { name: "x_Id_kelompok", selectId: "fproposal_pengabdianedit_x_Id_kelompok" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fproposal_pengabdianedit.lists.Id_kelompok?.lookupOptions.length) {
        options.data = { id: "x_Id_kelompok", form: "fproposal_pengabdianedit" };
    } else {
        options.ajax = { id: "x_Id_kelompok", form: "fproposal_pengabdianedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumInputLength = ew.selectMinimumInputLength;
    options = Object.assign({}, ew.selectOptions, options, ew.vars.tables.proposal_pengabdian.fields.Id_kelompok.selectOptions);
    ew.createSelect(options);
});
</script>
<?php } ?>
<input type="hidden" data-table="proposal_pengabdian" data-field="x_Id_kelompok" data-hidden="1" data-old name="o_Id_kelompok" id="o_Id_kelompok" value="<?= HtmlEncode($Page->Id_kelompok->OldValue ?? $Page->Id_kelompok->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } else { ?>
    <tr id="r_Id_kelompok"<?= $Page->Id_kelompok->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_proposal_pengabdian_Id_kelompok"><?= $Page->Id_kelompok->caption() ?><?= $Page->Id_kelompok->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } else { ?>
    <tr id="r_Judul_Penelitian"<?= $Page->Judul_Penelitian->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_proposal_pengabdian_Judul_Penelitian"><?= $Page->Judul_Penelitian->caption() ?><?= $Page->Judul_Penelitian->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($Page->IsMobileOrModal) { ?>
    <div id="r_Warna_Kaver"<?= $Page->Warna_Kaver->rowAttributes() ?>>
        <label id="elh_proposal_pengabdian_Warna_Kaver" for="x_Warna_Kaver" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Warna_Kaver->caption() ?><?= $Page->Warna_Kaver->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->Warna_Kaver->cellAttributes() ?>>
<span id="el_proposal_pengabdian_Warna_Kaver">
    <select
        id="x_Warna_Kaver"
        name="x_Warna_Kaver"
        class="form-select ew-select<?= $Page->Warna_Kaver->isInvalidClass() ?>"
        <?php if (!$Page->Warna_Kaver->IsNativeSelect) { ?>
        data-select2-id="fproposal_pengabdianedit_x_Warna_Kaver"
        <?php } ?>
        data-table="proposal_pengabdian"
...
<script>
loadjs.ready("fproposal_pengabdianedit", function() {
    var options = { name: "x_Warna_Kaver", selectId: "fproposal_pengabdianedit_x_Warna_Kaver" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fproposal_pengabdianedit.lists.Warna_Kaver?.lookupOptions.length) {
        options.data = { id: "x_Warna_Kaver", form: "fproposal_pengabdianedit" };
    } else {
        options.ajax = { id: "x_Warna_Kaver", form: "fproposal_pengabdianedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
    options = Object.assign({}, ew.selectOptions, options, ew.vars.tables.proposal_pengabdian.fields.Warna_Kaver.selectOptions);
    ew.createSelect(options);
});
</script>
<?php } ?>
...
<?php } else { ?>
    <tr id="r_Warna_Kaver"<?= $Page->Warna_Kaver->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_proposal_pengabdian_Warna_Kaver"><?= $Page->Warna_Kaver->caption() ?><?= $Page->Warna_Kaver->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($Page->IsMobileOrModal) { ?>
    <div id="r_Lembar_Pengesahan"<?= $Page->Lembar_Pengesahan->rowAttributes() ?>>
        <label id="elh_proposal_pengabdian_Lembar_Pengesahan" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Lembar_Pengesahan->caption() ?><?= $Page->Lembar_Pengesahan->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->Lembar_Pengesahan->cellAttributes() ?>>
<span id="el_proposal_pengabdian_Lembar_Pengesahan">
...
<?php } else { ?>
    <tr id="r_Lembar_Pengesahan"<?= $Page->Lembar_Pengesahan->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_proposal_pengabdian_Lembar_Pengesahan"><?= $Page->Lembar_Pengesahan->caption() ?><?= $Page->Lembar_Pengesahan->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($Page->IsMobileOrModal) { ?>
    <div id="r_Soft_copy_Proposal"<?= $Page->Soft_copy_Proposal->rowAttributes() ?>>
        <label id="elh_proposal_pengabdian_Soft_copy_Proposal" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Soft_copy_Proposal->caption() ?><?= $Page->Soft_copy_Proposal->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->Soft_copy_Proposal->cellAttributes() ?>>
<span id="el_proposal_pengabdian_Soft_copy_Proposal">
...
<input type="hidden" name="fa_x_Soft_copy_Proposal" id= "fa_x_Soft_copy_Proposal" value="<?= (Post("fa_x_Soft_copy_Proposal") == "0") ? "0" : "1" ?>">
...
<?php } else { ?>
    <tr id="r_Soft_copy_Proposal"<?= $Page->Soft_copy_Proposal->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_proposal_pengabdian_Soft_copy_Proposal"><?= $Page->Soft_copy_Proposal->caption() ?><?= $Page->Soft_copy_Proposal->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($Page->IsMobileOrModal) { ?>
    <div id="r_Surat_Pernyataan_Tidak_Studi"<?= $Page->Surat_Pernyataan_Tidak_Studi->rowAttributes() ?>>
        <label id="elh_proposal_pengabdian_Surat_Pernyataan_Tidak_Studi" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Surat_Pernyataan_Tidak_Studi->caption() ?><?= $Page->Surat_Pernyataan_Tidak_Studi->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->Surat_Pernyataan_Tidak_Studi->cellAttributes() ?>>
<span id="el_proposal_pengabdian_Surat_Pernyataan_Tidak_Studi">
...
<input type="hidden" name="fa_x_Surat_Pernyataan_Tidak_Studi" id= "fa_x_Surat_Pernyataan_Tidak_Studi" value="<?= (Post("fa_x_Surat_Pernyataan_Tidak_Studi") == "0") ? "0" : "1" ?>">
...
<?php } else { ?>
    <tr id="r_Surat_Pernyataan_Tidak_Studi"<?= $Page->Surat_Pernyataan_Tidak_Studi->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_proposal_pengabdian_Surat_Pernyataan_Tidak_Studi"><?= $Page->Surat_Pernyataan_Tidak_Studi->caption() ?><?= $Page->Surat_Pernyataan_Tidak_Studi->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fproposal_pengabdianedit"><?= $Language->phrase("SaveBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fproposal_pengabdianedit" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
...
<script>
loadjs.ready("head", function() { $("#fproposal_pengabdianedit:first *:input[type!=hidden]:first").focus(),$("input").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()}),$("select").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()}),$("radio").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()})});
</script>
<?php } ?>
<script>
