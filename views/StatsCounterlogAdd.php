...
<div class="col-md-12">
  <div class="card shadow-sm">
    ...
    <div class="card-body">
<?php } ?>
<form name="fstats_counterlogadd" id="fstats_counterlogadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
...
<?php } else { ?>
<table id="tbl_stats_counterlogadd" class="<?= $Page->TableClass ?>"><!-- table* -->
<?php } ?>
...
<script>
loadjs.ready(["fstats_counterlogadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fstats_counterlogadd", "x_First_Visit", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fstats_counterlogadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fstats_counterlogadd", "x_Last_Visit", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fstats_counterlogadd", "jquerynumber"], function() {
	ew.createjQueryNumber("fstats_counterlogadd", "x_Counter", {"number": true, "decimals": 0, "dec_point": "<?php echo $DECIMAL_SEPARATOR ?>", "thousands_sep" : "<?php echo $GROUPING_SEPARATOR ?>"});
});
</script>
</span>
</div></div>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fstats_counterlogadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fstats_counterlogadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
