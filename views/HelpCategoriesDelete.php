...
$Page->showMessage();
?>
<form name="fhelp_categoriesdelete" id="fhelp_categoriesdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
...
<span id="el<?= $Page->RowCount ?>_help_categories_Category_ID" class="el_help_categories_Category_ID">
...
<span id="el<?= $Page->RowCount ?>_help_categories__Language" class="el_help_categories__Language">
...
<span id="el<?= $Page->RowCount ?>_help_categories_Category_Description" class="el_help_categories_Category_Description">
