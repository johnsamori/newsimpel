...
<div class="col-md-12">
  <div class="card shadow-sm">
    ...
    <div class="card-body">
<?php } ?>
<form name="fhelp_categoriesedit" id="fhelp_categoriesedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<script>
...
<?php } else { ?>
<table id="tbl_help_categoriesedit" class="<?= $Page->TableClass ?>"><!-- table* -->
<?php } ?>
...
<?php } else { ?>
    <tr id="r_Category_ID"<?= $Page->Category_ID->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_help_categories_Category_ID"><?= $Page->Category_ID->caption() ?><?= $Page->Category_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } else { ?>
    <tr id="r__Language"<?= $Page->_Language->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_help_categories__Language"><?= $Page->_Language->caption() ?><?= $Page->_Language->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } else { ?>
    <tr id="r_Category_Description"<?= $Page->Category_Description->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_help_categories_Category_Description"><?= $Page->Category_Description->caption() ?><?= $Page->Category_Description->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
