...
<div class="col-md-12">
  <div class="card shadow-sm">
    ...
    <div class="card-body">
<?php } ?>
<form name="fproposal_penelitianedit" id="fproposal_penelitianedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { proposal_penelitian: currentTable } });
var currentPageID = ew.PAGE_ID = "edit";
var currentForm;
var fproposal_penelitianedit;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fproposal_penelitianedit")
        .setPageId("edit")
...
<?php } else { ?>
<table id="tbl_proposal_penelitianedit" class="<?= $Page->TableClass ?>"><!-- table* -->
<?php } ?>
...
<span id="el_proposal_penelitian_Id_kelompok">
    <select
        ...
        data-select2-id="fproposal_penelitianedit_x_Id_kelompok"
        <?php } ?>
...
<?php if (!$Page->Id_kelompok->IsNativeSelect) { ?>
<script>
loadjs.ready("fproposal_penelitianedit", function() {
    var options = { name: "x_Id_kelompok", selectId: "fproposal_penelitianedit_x_Id_kelompok" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fproposal_penelitianedit.lists.Id_kelompok?.lookupOptions.length) {
        options.data = { id: "x_Id_kelompok", form: "fproposal_penelitianedit" };
    } else {
        options.ajax = { id: "x_Id_kelompok", form: "fproposal_penelitianedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<?php } ?>
<input type="hidden" data-table="proposal_penelitian" data-field="x_Id_kelompok" data-hidden="1" data-old name="o_Id_kelompok" id="o_Id_kelompok" value="<?= HtmlEncode($Page->Id_kelompok->OldValue ?? $Page->Id_kelompok->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } else { ?>
...
<span id="el_proposal_penelitian_Warna_Kaver">
    <select
        ...
        data-select2-id="fproposal_penelitianedit_x_Warna_Kaver"
        <?php } ?>
        data-table="proposal_penelitian"
...
<script>
loadjs.ready("fproposal_penelitianedit", function() {
    var options = { name: "x_Warna_Kaver", selectId: "fproposal_penelitianedit_x_Warna_Kaver" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fproposal_penelitianedit.lists.Warna_Kaver?.lookupOptions.length) {
        options.data = { id: "x_Warna_Kaver", form: "fproposal_penelitianedit" };
    } else {
        options.ajax = { id: "x_Warna_Kaver", form: "fproposal_penelitianedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fproposal_penelitianedit"><?= $Language->phrase("SaveBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fproposal_penelitianedit" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
