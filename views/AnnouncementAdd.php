...
<div class="col-md-12">
  <div class="card shadow-sm">
    ...
    <div class="card-body">
<?php } ?>
<form name="fannouncementadd" id="fannouncementadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
...
<?php } else { ?>
<table id="tbl_announcementadd" class="<?= $Page->TableClass ?>"><!-- table* -->
<?php } ?>
...
loadjs.ready(["fannouncementadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fannouncementadd", "x_Date_LastUpdate", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fannouncementadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fannouncementadd", "x_Date_Start", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fannouncementadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fannouncementadd", "x_Date_End", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fannouncementadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fannouncementadd", "x_Date_Created", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
