...
<div class="col-md-12">
  <div class="card shadow-sm">
    ...
    <div class="card-body">
<?php } ?>
<form name="fhelp_categoriesadd" id="fhelp_categoriesadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
...
<?php } else { ?>
<table id="tbl_help_categoriesadd" class="<?= $Page->TableClass ?>"><!-- table* -->
<?php } ?>
