...
<div class="col-md-12">
  <div class="card shadow-sm">
    ...
    <div class="card-body">
<?php } ?>
<form name="fjabatan_fungsionalview" id="fjabatan_fungsionalview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<?php if (!$Page->isExport()) { ?>
<script>
...
<?php if ($Page->no->Visible) { // no ?>
    <tr id="r_no"<?= $Page->no->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_jabatan_fungsional_no"><?= $Page->no->caption() ?></span></td>
...
<?php if ($Page->Nama_Jabatan->Visible) { // Nama_Jabatan ?>
    <tr id="r_Nama_Jabatan"<?= $Page->Nama_Jabatan->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_jabatan_fungsional_Nama_Jabatan"><?= $Page->Nama_Jabatan->caption() ?></span></td>
