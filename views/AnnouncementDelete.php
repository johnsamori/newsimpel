...
$Page->showMessage();
?>
<form name="fannouncementdelete" id="fannouncementdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
...
<span id="el<?= $Page->RowCount ?>_announcement_Announcement_ID" class="el_announcement_Announcement_ID">
...
<span id="el<?= $Page->RowCount ?>_announcement_Is_Active" class="el_announcement_Is_Active">
...
<span id="el<?= $Page->RowCount ?>_announcement_Topic" class="el_announcement_Topic">
...
<span id="el<?= $Page->RowCount ?>_announcement_Date_LastUpdate" class="el_announcement_Date_LastUpdate">
...
<span id="el<?= $Page->RowCount ?>_announcement__Language" class="el_announcement__Language">
...
<span id="el<?= $Page->RowCount ?>_announcement_Auto_Publish" class="el_announcement_Auto_Publish">
...
<span id="el<?= $Page->RowCount ?>_announcement_Date_Start" class="el_announcement_Date_Start">
...
<span id="el<?= $Page->RowCount ?>_announcement_Date_End" class="el_announcement_Date_End">
...
<span id="el<?= $Page->RowCount ?>_announcement_Date_Created" class="el_announcement_Date_Created">
...
<span id="el<?= $Page->RowCount ?>_announcement_Created_By" class="el_announcement_Created_By">
...
<span id="el<?= $Page->RowCount ?>_announcement_Translated_ID" class="el_announcement_Translated_ID">
