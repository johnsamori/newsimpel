...
<div class="col-md-12">
  <div class="card shadow-sm">
    ...
    <div class="card-body">
<?php } ?>
<form name="fstats_counteredit" id="fstats_counteredit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { stats_counter: currentTable } });
var currentPageID = ew.PAGE_ID = "edit";
var currentForm;
var fstats_counteredit;
...
<?php } else { ?>
<table id="tbl_stats_counteredit" class="<?= $Page->TableClass ?>"><!-- table* -->
<?php } ?>
...
<input type="hidden" data-table="stats_counter" data-field="x_Type" data-hidden="1" data-old name="o_Type" id="o_Type" value="<?= HtmlEncode($Page->Type->OldValue ?? $Page->Type->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } else { ?>
...
<input type="hidden" data-table="stats_counter" data-field="x_Variable" data-hidden="1" data-old name="o_Variable" id="o_Variable" value="<?= HtmlEncode($Page->Variable->OldValue ?? $Page->Variable->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } else { ?>
...
loadjs.ready(["fstats_counteredit", "jquerynumber"], function() {
	ew.createjQueryNumber("fstats_counteredit", "x_Counter", {"number": true, "decimals": 0, "dec_point": "<?php echo $DECIMAL_SEPARATOR ?>", "thousands_sep" : "<?php echo $GROUPING_SEPARATOR ?>"});
});
</script>
</span>
</div></div>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fstats_counteredit"><?= $Language->phrase("SaveBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fstats_counteredit" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
...
<script>
loadjs.ready("head", function() { $("#fstats_counteredit:first *:input[type!=hidden]:first").focus(),$("input").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()}),$("select").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()}),$("radio").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()})});
</script>
<?php } ?>
<script>
