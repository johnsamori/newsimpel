...
<div class="col-md-12">
  <div class="card shadow-sm">
    ...
    <div class="card-body">
<?php } ?>
<form name="flaporan_pengabdianedit" id="flaporan_pengabdianedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { laporan_pengabdian: currentTable } });
var currentPageID = ew.PAGE_ID = "edit";
var currentForm;
var flaporan_pengabdianedit;
...
<?php } else { ?>
<table id="tbl_laporan_pengabdianedit" class="<?= $Page->TableClass ?>"><!-- table* -->
<?php } ?>
...
<span id="el_laporan_pengabdian_Id_kelompok">
    <select
        ...
        data-select2-id="flaporan_pengabdianedit_x_Id_kelompok"
        <?php } ?>
...
<?php if (!$Page->Id_kelompok->IsNativeSelect) { ?>
<script>
loadjs.ready("flaporan_pengabdianedit", function() {
    var options = { name: "x_Id_kelompok", selectId: "flaporan_pengabdianedit_x_Id_kelompok" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (flaporan_pengabdianedit.lists.Id_kelompok?.lookupOptions.length) {
        options.data = { id: "x_Id_kelompok", form: "flaporan_pengabdianedit" };
    } else {
        options.ajax = { id: "x_Id_kelompok", form: "flaporan_pengabdianedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<?php } ?>
<input type="hidden" data-table="laporan_pengabdian" data-field="x_Id_kelompok" data-hidden="1" data-old name="o_Id_kelompok" id="o_Id_kelompok" value="<?= HtmlEncode($Page->Id_kelompok->OldValue ?? $Page->Id_kelompok->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } else { ?>
...
<input type="hidden" name="fa_x_Surat_Keterangan_dari_Tempat_Mengabdi" id= "fa_x_Surat_Keterangan_dari_Tempat_Mengabdi" value="<?= (Post("fa_x_Surat_Keterangan_dari_Tempat_Mengabdi") == "0") ? "0" : "1" ?>">
...
<input type="hidden" name="fa_x_Dokumentasi" id= "fa_x_Dokumentasi" value="<?= (Post("fa_x_Dokumentasi") == "0") ? "0" : "1" ?>">
...
<input type="hidden" name="fa_x_Daftar_Hadir" id= "fa_x_Daftar_Hadir" value="<?= (Post("fa_x_Daftar_Hadir") == "0") ? "0" : "1" ?>">
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="flaporan_pengabdianedit"><?= $Language->phrase("SaveBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="flaporan_pengabdianedit" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
...
<script>
loadjs.ready("head", function() { $("#flaporan_pengabdianedit:first *:input[type!=hidden]:first").focus(),$("input").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()}),$("select").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()}),$("radio").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()})});
</script>
<?php } ?>
<script>
