...
$Page->showMessage();
?>
<form name="frumpun_ilmudelete" id="frumpun_ilmudelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
...
<?php if ($Page->no->Visible) { // no ?>
        <th class="<?= $Page->no->headerCellClass() ?>"><span id="elh_rumpun_ilmu_no" class="rumpun_ilmu_no"><?= $Page->no->caption() ?></span></th>
<?php } ?>
<?php if ($Page->Rumpun_Ilmu->Visible) { // Rumpun_Ilmu ?>
        <th class="<?= $Page->Rumpun_Ilmu->headerCellClass() ?>"><span id="elh_rumpun_ilmu_Rumpun_Ilmu" class="rumpun_ilmu_Rumpun_Ilmu"><?= $Page->Rumpun_Ilmu->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
