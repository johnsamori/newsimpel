...
<div class="col-md-12">
  <div class="card shadow-sm">
    ...
    <div class="card-body">
<?php } ?>
<form name="fproposal_pengabdianadd" id="fproposal_pengabdianadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
...
<?php } else { ?>
<table id="tbl_proposal_pengabdianadd" class="<?= $Page->TableClass ?>"><!-- table* -->
<?php } ?>
...
<span id="el_proposal_pengabdian_Id_kelompok">
    <select
        ...
        data-select2-id="fproposal_pengabdianadd_x_Id_kelompok"
        <?php } ?>
...
<?php if (!$Page->Id_kelompok->IsNativeSelect) { ?>
<script>
loadjs.ready("fproposal_pengabdianadd", function() {
    var options = { name: "x_Id_kelompok", selectId: "fproposal_pengabdianadd_x_Id_kelompok" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fproposal_pengabdianadd.lists.Id_kelompok?.lookupOptions.length) {
        options.data = { id: "x_Id_kelompok", form: "fproposal_pengabdianadd" };
    } else {
        options.ajax = { id: "x_Id_kelompok", form: "fproposal_pengabdianadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_proposal_pengabdian_Warna_Kaver">
    <select
        ...
        data-select2-id="fproposal_pengabdianadd_x_Warna_Kaver"
        <?php } ?>
        data-table="proposal_pengabdian"
...
<script>
loadjs.ready("fproposal_pengabdianadd", function() {
    var options = { name: "x_Warna_Kaver", selectId: "fproposal_pengabdianadd_x_Warna_Kaver" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fproposal_pengabdianadd.lists.Warna_Kaver?.lookupOptions.length) {
        options.data = { id: "x_Warna_Kaver", form: "fproposal_pengabdianadd" };
    } else {
        options.ajax = { id: "x_Warna_Kaver", form: "fproposal_pengabdianadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fproposal_pengabdianadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fproposal_pengabdianadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
...
<script>
loadjs.ready("head", function() { $("#fproposal_pengabdianadd:first *:input[type!=hidden]:first").focus(),$("input").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()}),$("select").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()}),$("radio").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()})});
</script>
<?php } ?>
<script>
