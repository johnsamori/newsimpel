...
<div class="col-md-12">
  <div class="card shadow-sm">
    ...
    <div class="card-body">
<?php } ?>
<form name="fstats_hourview" id="fstats_hourview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<?php if (!$Page->isExport()) { ?>
<script>
...
<?php if ($Page->Year->Visible) { // Year ?>
    <tr id="r_Year"<?= $Page->Year->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_stats_hour_Year"><?= $Page->Year->caption() ?></span></td>
...
<?php if ($Page->Month->Visible) { // Month ?>
    <tr id="r_Month"<?= $Page->Month->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_stats_hour_Month"><?= $Page->Month->caption() ?></span></td>
...
<?php if ($Page->Date->Visible) { // Date ?>
    <tr id="r_Date"<?= $Page->Date->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_stats_hour_Date"><?= $Page->Date->caption() ?></span></td>
...
<?php if ($Page->Hour->Visible) { // Hour ?>
    <tr id="r_Hour"<?= $Page->Hour->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_stats_hour_Hour"><?= $Page->Hour->caption() ?></span></td>
...
<?php if ($Page->Hits->Visible) { // Hits ?>
    <tr id="r_Hits"<?= $Page->Hits->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_stats_hour_Hits"><?= $Page->Hits->caption() ?></span></td>
