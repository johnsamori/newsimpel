...
$Page->showMessage();
?>
<form name="fsettingsdelete" id="fsettingsdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
...
<span id="el<?= $Page->RowCount ?>_settings_Option_ID" class="el_settings_Option_ID">
...
<span id="el<?= $Page->RowCount ?>_settings_Option_Default" class="el_settings_Option_Default">
...
<span id="el<?= $Page->RowCount ?>_settings_Show_Announcement" class="el_settings_Show_Announcement">
...
<span id="el<?= $Page->RowCount ?>_settings_Use_Announcement_Table" class="el_settings_Use_Announcement_Table">
...
<span id="el<?= $Page->RowCount ?>_settings_Maintenance_Mode" class="el_settings_Maintenance_Mode">
...
<span id="el<?= $Page->RowCount ?>_settings_Maintenance_Finish_DateTime" class="el_settings_Maintenance_Finish_DateTime">
...
<span id="el<?= $Page->RowCount ?>_settings_Auto_Normal_After_Maintenance" class="el_settings_Auto_Normal_After_Maintenance">
