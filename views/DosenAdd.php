...
<div class="col-md-12">
  <div class="card shadow-sm">
    ...
    <div class="card-body">
<?php } ?>
<form name="fdosenadd" id="fdosenadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
...
<?php } else { ?>
<table id="tbl_dosenadd" class="<?= $Page->TableClass ?>"><!-- table* -->
<?php } ?>
...
<span id="el_dosen_Jenjang_Pendidikan">
    <select
        ...
        data-select2-id="fdosenadd_x_Jenjang_Pendidikan"
        <?php } ?>
        data-table="dosen"
...
<?php if (!$Page->Jenjang_Pendidikan->IsNativeSelect) { ?>
<script>
loadjs.ready("fdosenadd", function() {
    var options = { name: "x_Jenjang_Pendidikan", selectId: "fdosenadd_x_Jenjang_Pendidikan" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fdosenadd.lists.Jenjang_Pendidikan?.lookupOptions.length) {
        options.data = { id: "x_Jenjang_Pendidikan", form: "fdosenadd" };
    } else {
        options.ajax = { id: "x_Jenjang_Pendidikan", form: "fdosenadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_dosen_Jabatan_Fungsional">
    <select
        ...
        data-select2-id="fdosenadd_x_Jabatan_Fungsional"
        <?php } ?>
        data-table="dosen"
...
<script>
loadjs.ready("fdosenadd", function() {
    var options = { name: "x_Jabatan_Fungsional", selectId: "fdosenadd_x_Jabatan_Fungsional" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fdosenadd.lists.Jabatan_Fungsional?.lookupOptions.length) {
        options.data = { id: "x_Jabatan_Fungsional", form: "fdosenadd" };
    } else {
        options.ajax = { id: "x_Jabatan_Fungsional", form: "fdosenadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_dosen_Kepakaran">
    <select
        ...
        data-select2-id="fdosenadd_x_Kepakaran"
        <?php } ?>
        data-table="dosen"
...
<script>
loadjs.ready("fdosenadd", function() {
    var options = { name: "x_Kepakaran", selectId: "fdosenadd_x_Kepakaran" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fdosenadd.lists.Kepakaran?.lookupOptions.length) {
        options.data = { id: "x_Kepakaran", form: "fdosenadd" };
    } else {
        options.ajax = { id: "x_Kepakaran", form: "fdosenadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_dosen_Rumpun_Ilmu">
    <select
        ...
        data-select2-id="fdosenadd_x_Rumpun_Ilmu"
        <?php } ?>
        data-table="dosen"
...
<script>
loadjs.ready("fdosenadd", function() {
    var options = { name: "x_Rumpun_Ilmu", selectId: "fdosenadd_x_Rumpun_Ilmu" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fdosenadd.lists.Rumpun_Ilmu?.lookupOptions.length) {
        options.data = { id: "x_Rumpun_Ilmu", form: "fdosenadd" };
    } else {
        options.ajax = { id: "x_Rumpun_Ilmu", form: "fdosenadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumInputLength = ew.selectMinimumInputLength;
...
<span id="el_dosen_Aktif">
    <select
        ...
        data-select2-id="fdosenadd_x_Aktif"
        <?php } ?>
        data-table="dosen"
        data-field="x_Aktif"
...
<script>
loadjs.ready("fdosenadd", function() {
    var options = { name: "x_Aktif", selectId: "fdosenadd_x_Aktif" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fdosenadd.lists.Aktif?.lookupOptions.length) {
        options.data = { id: "x_Aktif", form: "fdosenadd" };
    } else {
        options.ajax = { id: "x_Aktif", form: "fdosenadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_dosen_Validasi">
    <select
        ...
        data-select2-id="fdosenadd_x_Validasi"
        <?php } ?>
        data-table="dosen"
...
<script>
loadjs.ready("fdosenadd", function() {
    var options = { name: "x_Validasi", selectId: "fdosenadd_x_Validasi" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fdosenadd.lists.Validasi?.lookupOptions.length) {
        options.data = { id: "x_Validasi", form: "fdosenadd" };
    } else {
        options.ajax = { id: "x_Validasi", form: "fdosenadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
