...
<div class="col-md-12">
  <div class="card shadow-sm">
    ...
    <div class="card-body">
<?php } ?>
<form name="fannouncementedit" id="fannouncementedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<script>
...
<?php } else { ?>
<table id="tbl_announcementedit" class="<?= $Page->TableClass ?>"><!-- table* -->
<?php } ?>
...
<?php } else { ?>
    <tr id="r_Announcement_ID"<?= $Page->Announcement_ID->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_announcement_Announcement_ID"><?= $Page->Announcement_ID->caption() ?><?= $Page->Announcement_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } else { ?>
    <tr id="r_Is_Active"<?= $Page->Is_Active->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_announcement_Is_Active"><?= $Page->Is_Active->caption() ?><?= $Page->Is_Active->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<input type="<?= $Page->Topic->getInputTextType() ?>" name="x_Topic" id="x_Topic" data-table="announcement" data-field="x_Topic" value="<?= $Page->Topic->EditValue ?>" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->Topic->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Topic->formatPattern()) ?>"<?= $Page->Topic->editAttributes() ?> aria-describedby="x_Topic_help">
...
<?php } else { ?>
    <tr id="r_Topic"<?= $Page->Topic->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_announcement_Topic"><?= $Page->Topic->caption() ?><?= $Page->Topic->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($Page->IsMobileOrModal) { ?>
    <div id="r__Message"<?= $Page->_Message->rowAttributes() ?>>
        <label id="elh_announcement__Message" for="x__Message" class="<?= $Page->LeftColumnClass ?>"><?= $Page->_Message->caption() ?><?= $Page->_Message->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->_Message->cellAttributes() ?>>
<span id="el_announcement__Message">
<textarea data-table="announcement" data-field="x__Message" name="x__Message" id="x__Message" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->_Message->getPlaceHolder()) ?>"<?= $Page->_Message->editAttributes() ?> aria-describedby="x__Message_help"><?= $Page->_Message->EditValue ?></textarea>
...
<?php } else { ?>
    <tr id="r__Message"<?= $Page->_Message->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_announcement__Message"><?= $Page->_Message->caption() ?><?= $Page->_Message->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
loadjs.ready(["fannouncementedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fannouncementedit", "x_Date_LastUpdate", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
    <tr id="r_Date_LastUpdate"<?= $Page->Date_LastUpdate->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_announcement_Date_LastUpdate"><?= $Page->Date_LastUpdate->caption() ?><?= $Page->Date_LastUpdate->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } else { ?>
    <tr id="r__Language"<?= $Page->_Language->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_announcement__Language"><?= $Page->_Language->caption() ?><?= $Page->_Language->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } else { ?>
    <tr id="r_Auto_Publish"<?= $Page->Auto_Publish->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_announcement_Auto_Publish"><?= $Page->Auto_Publish->caption() ?><?= $Page->Auto_Publish->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
loadjs.ready(["fannouncementedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fannouncementedit", "x_Date_Start", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
    <tr id="r_Date_Start"<?= $Page->Date_Start->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_announcement_Date_Start"><?= $Page->Date_Start->caption() ?><?= $Page->Date_Start->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<input type="<?= $Page->Date_End->getInputTextType() ?>" name="x_Date_End" id="x_Date_End" data-table="announcement" data-field="x_Date_End" value="<?= $Page->Date_End->EditValue ?>" placeholder="<?= HtmlEncode($Page->Date_End->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Date_End->formatPattern()) ?>"<?= $Page->Date_End->editAttributes() ?> aria-describedby="x_Date_End_help">
...
loadjs.ready(["fannouncementedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fannouncementedit", "x_Date_End", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
    <tr id="r_Date_End"<?= $Page->Date_End->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_announcement_Date_End"><?= $Page->Date_End->caption() ?><?= $Page->Date_End->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
loadjs.ready(["fannouncementedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fannouncementedit", "x_Date_Created", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<?php } else { ?>
    <tr id="r_Date_Created"<?= $Page->Date_Created->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_announcement_Date_Created"><?= $Page->Date_Created->caption() ?><?= $Page->Date_Created->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } else { ?>
    <tr id="r_Created_By"<?= $Page->Created_By->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_announcement_Created_By"><?= $Page->Created_By->caption() ?><?= $Page->Created_By->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php } else { ?>
    <tr id="r_Translated_ID"<?= $Page->Translated_ID->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_announcement_Translated_ID"><?= $Page->Translated_ID->caption() ?><?= $Page->Translated_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
