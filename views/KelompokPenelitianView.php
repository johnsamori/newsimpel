...
<div class="col-md-12">
  <div class="card shadow-sm">
    ...
    <div class="card-body">
<?php } ?>
<form name="fkelompok_penelitianview" id="fkelompok_penelitianview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<?php if (!$Page->isExport()) { ?>
<script>
...
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fkelompok_penelitianview")
        .setPageId("view")
        .build();
    window[form.id] = form;
    currentForm = form;
...
<?php if ($Page->Id_Kelompok->Visible) { // Id_Kelompok ?>
    <tr id="r_Id_Kelompok"<?= $Page->Id_Kelompok->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_kelompok_penelitian_Id_Kelompok"><?= $Page->Id_Kelompok->caption() ?></span></td>
...
<?php if ($Page->Nama_Ketua->Visible) { // Nama_Ketua ?>
    <tr id="r_Nama_Ketua"<?= $Page->Nama_Ketua->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_kelompok_penelitian_Nama_Ketua"><?= $Page->Nama_Ketua->caption() ?></span></td>
...
<?php if ($Page->Nama_Anggota_1->Visible) { // Nama_Anggota_1 ?>
    <tr id="r_Nama_Anggota_1"<?= $Page->Nama_Anggota_1->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_kelompok_penelitian_Nama_Anggota_1"><?= $Page->Nama_Anggota_1->caption() ?></span></td>
...
<?php if ($Page->Nama_Anggota_2->Visible) { // Nama_Anggota_2 ?>
    <tr id="r_Nama_Anggota_2"<?= $Page->Nama_Anggota_2->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_kelompok_penelitian_Nama_Anggota_2"><?= $Page->Nama_Anggota_2->caption() ?></span></td>
...
<?php if ($Page->Tanggal->Visible) { // Tanggal ?>
    <tr id="r_Tanggal"<?= $Page->Tanggal->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_kelompok_penelitian_Tanggal"><?= $Page->Tanggal->caption() ?></span></td>
        <td data-name="Tanggal"<?= $Page->Tanggal->cellAttributes() ?>>
<span id="el_kelompok_penelitian_Tanggal">
