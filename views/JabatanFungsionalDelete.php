...
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fjabatan_fungsionaldelete")
        .setPageId("delete")
        .build();
    window[form.id] = form;
    currentForm = form;
...
$Page->showMessage();
?>
<form name="fjabatan_fungsionaldelete" id="fjabatan_fungsionaldelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
...
<?php if ($Page->no->Visible) { // no ?>
        <th class="<?= $Page->no->headerCellClass() ?>"><span id="elh_jabatan_fungsional_no" class="jabatan_fungsional_no"><?= $Page->no->caption() ?></span></th>
<?php } ?>
<?php if ($Page->Nama_Jabatan->Visible) { // Nama_Jabatan ?>
        <th class="<?= $Page->Nama_Jabatan->headerCellClass() ?>"><span id="elh_jabatan_fungsional_Nama_Jabatan" class="jabatan_fungsional_Nama_Jabatan"><?= $Page->Nama_Jabatan->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
