...
$Page->showMessage();
?>
<form name="fstats_yeardelete" id="fstats_yeardelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
...
<?php if ($Page->Year->Visible) { // Year ?>
        <th class="<?= $Page->Year->headerCellClass() ?>"><span id="elh_stats_year_Year" class="stats_year_Year"><?= $Page->Year->caption() ?></span></th>
<?php } ?>
<?php if ($Page->Hits->Visible) { // Hits ?>
        <th class="<?= $Page->Hits->headerCellClass() ?>"><span id="elh_stats_year_Hits" class="stats_year_Hits"><?= $Page->Hits->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
