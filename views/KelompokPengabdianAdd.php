...
<div class="col-md-12">
  <div class="card shadow-sm">
    ...
    <div class="card-body">
<?php } ?>
<form name="fkelompok_pengabdianadd" id="fkelompok_pengabdianadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
...
<?php } else { ?>
<table id="tbl_kelompok_pengabdianadd" class="<?= $Page->TableClass ?>"><!-- table* -->
<?php } ?>
...
<span id="el_kelompok_pengabdian_Nama_Ketua">
    <select
        ...
        data-select2-id="fkelompok_pengabdianadd_x_Nama_Ketua"
        <?php } ?>
...
<?php if (!$Page->Nama_Ketua->IsNativeSelect) { ?>
<script>
loadjs.ready("fkelompok_pengabdianadd", function() {
    var options = { name: "x_Nama_Ketua", selectId: "fkelompok_pengabdianadd_x_Nama_Ketua" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fkelompok_pengabdianadd.lists.Nama_Ketua?.lookupOptions.length) {
        options.data = { id: "x_Nama_Ketua", form: "fkelompok_pengabdianadd" };
    } else {
        options.ajax = { id: "x_Nama_Ketua", form: "fkelompok_pengabdianadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_kelompok_pengabdian_Nama_Anggota_1">
    <select
        ...
        data-select2-id="fkelompok_pengabdianadd_x_Nama_Anggota_1"
        <?php } ?>
        data-table="kelompok_pengabdian"
...
<script>
loadjs.ready("fkelompok_pengabdianadd", function() {
    var options = { name: "x_Nama_Anggota_1", selectId: "fkelompok_pengabdianadd_x_Nama_Anggota_1" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fkelompok_pengabdianadd.lists.Nama_Anggota_1?.lookupOptions.length) {
        options.data = { id: "x_Nama_Anggota_1", form: "fkelompok_pengabdianadd" };
    } else {
        options.ajax = { id: "x_Nama_Anggota_1", form: "fkelompok_pengabdianadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumInputLength = ew.selectMinimumInputLength;
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fkelompok_pengabdianadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fkelompok_pengabdianadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
