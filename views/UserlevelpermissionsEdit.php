...
<?php } else { ?>
<table id="tbl_userlevelpermissionsedit" class="<?= $Page->TableClass ?>"><!-- table* -->
<?php } ?>
...
loadjs.ready(["fuserlevelpermissionsedit", "jquerynumber"], function() {
	ew.createjQueryNumber("fuserlevelpermissionsedit", "x_User_Level_ID", {"number": true, "decimals": 0, "dec_point": "<?php echo $DECIMAL_SEPARATOR ?>", "thousands_sep" : "<?php echo $GROUPING_SEPARATOR ?>"});
});
</script>
<input type="hidden" data-table="userlevelpermissions" data-field="x_User_Level_ID" data-hidden="1" data-old name="o_User_Level_ID" id="o_User_Level_ID" value="<?= HtmlEncode($Page->User_Level_ID->OldValue ?? $Page->User_Level_ID->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } else { ?>
...
<input type="hidden" data-table="userlevelpermissions" data-field="x_Table_Name" data-hidden="1" data-old name="o_Table_Name" id="o_Table_Name" value="<?= HtmlEncode($Page->Table_Name->OldValue ?? $Page->Table_Name->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } else { ?>
...
<script type="text/javascript">
loadjs.ready(["fuserlevelpermissionsedit", "jquerynumber"], function() {
	ew.createjQueryNumber("fuserlevelpermissionsedit", "x__Permission", {"number": true, "decimals": 0, "dec_point": "<?php echo $DECIMAL_SEPARATOR ?>", "thousands_sep" : "<?php echo $GROUPING_SEPARATOR ?>"});
});
</script>
</span>
</div></div>
