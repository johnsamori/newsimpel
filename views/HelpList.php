...
<?php } ?>
<?php if (!$Page->IsModal) { ?>
<form name="fhelpsrch" id="fhelpsrch" class="ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>" novalidate autocomplete="on">
...
<?php if ($Page->Help_ID->Visible) { // Help_ID ?>
        <th data-name="Help_ID" class="<?= $Page->Help_ID->headerCellClass() ?>"><div id="elh_help_Help_ID" class="help_Help_ID"><?= $Page->renderFieldHeader($Page->Help_ID) ?></div></th>
<?php } ?>
...
<?php if ($Page->Order->Visible) { // Order ?>
        <th data-name="Order" class="<?= $Page->Order->headerCellClass() ?>"><div id="elh_help_Order" class="help_Order"><?= $Page->renderFieldHeader($Page->Order) ?></div></th>
<?php } ?>
<?php if ($Page->Display_in_Page->Visible) { // Display_in_Page ?>
        <th data-name="Display_in_Page" class="<?= $Page->Display_in_Page->headerCellClass() ?>"><div id="elh_help_Display_in_Page" class="help_Display_in_Page"><?= $Page->renderFieldHeader($Page->Display_in_Page) ?></div></th>
<?php } ?>
<?php if ($Page->Updated_By->Visible) { // Updated_By ?>
        <th data-name="Updated_By" class="<?= $Page->Updated_By->headerCellClass() ?>"><div id="elh_help_Updated_By" class="help_Updated_By"><?= $Page->renderFieldHeader($Page->Updated_By) ?></div></th>
<?php } ?>
<?php if ($Page->Last_Updated->Visible) { // Last_Updated ?>
        <th data-name="Last_Updated" class="<?= $Page->Last_Updated->headerCellClass() ?>"><div id="elh_help_Last_Updated" class="help_Last_Updated"><?= $Page->renderFieldHeader($Page->Last_Updated) ?></div></th>
<?php } ?>
<?php
