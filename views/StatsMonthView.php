...
<div class="col-md-12">
  <div class="card shadow-sm">
    ...
    <div class="card-body">
<?php } ?>
<form name="fstats_monthview" id="fstats_monthview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<?php if (!$Page->isExport()) { ?>
<script>
...
<?php if ($Page->Year->Visible) { // Year ?>
    <tr id="r_Year"<?= $Page->Year->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_stats_month_Year"><?= $Page->Year->caption() ?></span></td>
...
<?php if ($Page->Month->Visible) { // Month ?>
    <tr id="r_Month"<?= $Page->Month->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_stats_month_Month"><?= $Page->Month->caption() ?></span></td>
...
<?php if ($Page->Hits->Visible) { // Hits ?>
    <tr id="r_Hits"<?= $Page->Hits->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_stats_month_Hits"><?= $Page->Hits->caption() ?></span></td>
