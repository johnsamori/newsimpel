...
class MenuItem
{
    ...
    public $Text = "";
    public $Url = "";
	public $Source = ""; // Modified by Masino Sinaga, July 17, 2022
    public $ParentId = -1;
    ...
    // Constructor --> added $src to store table name by Masino Sinaga, July 17, 2022
    public function __construct($id, $name, $text, $url, $parentId = -1, $src = "", $allowed = true, $isHeader = false, $isCustomUrl = false, $icon = "", $label = "", $isNavbarItem = false, $isSidebarItem = false)
    {
        $this->Id = $id;
        $this->Name = $name;
        $this->Text = $text;
