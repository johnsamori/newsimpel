...
$LANGUAGES = [["en-US","","english.xml"],["id-ID","","indonesian.xml"]];
...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'P7iXvtZepr6MSL7W', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/new2023.css", // Project stylesheet file name
    ...
    "SIDEBAR_CLASS" => "main-sidebar sidebar-dark-red elevation-4", // CSS class(es) for sidebar
	...
	"MS_USE_MESSAGE_BOX_INSTEAD_OF_TOAST" => true, // Use Alertify message box, make sure USE_JAVASCRIPT_MESSAGE always set to true!
    ...
    // Export Log
    "EXPORT_PATH" => "export-7c26a499-9388-4839-9706-e82595128fff", // Export folder
    ...
    "ADMIN_USER_NAME" => "john", // Administrator user name
    "ADMIN_PASSWORD" => "Mko0nji9bhu8!@", // Administrator password
    ...
    "USER_ACTIVATE_FILTER" => "(`Activated` = 'Y')",
    ...
    "USER_PROFILE_SESSION_TIMEOUT" => 2,
    ...
    // Email
    "SENDER_EMAIL" => "admin@simpel.uncen.ac.id", // Sender email address
    "RECIPIENT_EMAIL" => "admin@simpel.uncen.ac.id", // Recipient email address
    ...
    "EXPORT_CLASSES" => [
        "email" => "ExportEmail",
        "html" => "ExportHtml",
		"print" => "ExportPrint", // added by Masino Sinaga, September 26, 2022
        "word" => "ExportWord",
        "excel" => "ExportExcel",
        "pdf" => "ExportPdfMasino",
        "csv" => "ExportCsv",
    ...
    */
    ...
    "FIXED_HEADER_TABLE_HEIGHT" => "h-400px", // CSS class for fixed header table height
