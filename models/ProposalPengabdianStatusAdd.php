 ...
 * Page class
 */
class ProposalPengabdianStatusAdd extends ProposalPengabdianStatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProposalPengabdianStatusAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "proposalpengabdianstatusadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "proposalpengabdianstatusview") {
