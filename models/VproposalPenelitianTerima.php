...
/**
 * Table class for vproposal_penelitian_terima
 */
class VproposalPenelitianTerima extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "vproposal_penelitian_terima";
        $this->Dbid = 'DB';
        ...
        $this->Nama_Anggota_2->Nullable = false; // NOT NULL field
        $this->Nama_Anggota_2->Required = true; // Required field
        $this->Nama_Anggota_2->setSelectMultiple(false); // Select one
        $this->Nama_Anggota_2->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->Nama_Anggota_2->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en-US":
                $this->Nama_Anggota_2->Lookup = new Lookup('Nama_Anggota_2', 'validasi', false, 'NIDN', ["Nama_Lengkap","","",""], '', '', [], [], [], [], [], [], '', '', "`Nama_Lengkap`");
                break;
            case "id-ID":
                $this->Nama_Anggota_2->Lookup = new Lookup('Nama_Anggota_2', 'validasi', false, 'NIDN', ["Nama_Lengkap","","",""], '', '', [], [], [], [], [], [], '', '', "`Nama_Lengkap`");
                break;
        ...
        $this->Nama_Anggota_2->SearchOperators = ["=", "<>"];
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->Status->Lookup = new Lookup('Status', 'vproposal_penelitian_terima', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
                break;
            case "id-ID":
                $this->Status->Lookup = new Lookup('Status', 'vproposal_penelitian_terima', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
                break;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "vproposal_penelitian_terima";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("vproposalpenelitianterimalist");
    }
    ...
    {
        global $Language;
        if ($pageName == "vproposalpenelitianterimaview") {
            return $Language->phrase("View");
        } elseif ($pageName == "vproposalpenelitianterimaedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "vproposalpenelitianterimaadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VproposalPenelitianTerimaView";
            case Config("API_ADD_ACTION"):
                return "VproposalPenelitianTerimaAdd";
            case Config("API_EDIT_ACTION"):
                return "VproposalPenelitianTerimaEdit";
            case Config("API_DELETE_ACTION"):
                return "VproposalPenelitianTerimaDelete";
            case Config("API_LIST_ACTION"):
                return "VproposalPenelitianTerimaList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("vproposalpenelitianterimaview", $parm);
        } else {
            $url = $this->keyUrl("vproposalpenelitianterimaview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "vproposalpenelitianterimaadd?" . $parm;
        } else {
            $url = "vproposalpenelitianterimaadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vproposalpenelitianterimaedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vproposalpenelitianterimalist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vproposalpenelitianterimaadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vproposalpenelitianterimalist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("vproposalpenelitianterimadelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "VproposalPenelitianTerimaList";
