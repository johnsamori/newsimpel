 ...
 * Page class
 */
class ProposalPengabdianAdd extends ProposalPengabdian
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProposalPengabdianAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "proposalpengabdianadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "proposalpengabdianview") {
