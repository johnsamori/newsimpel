 ...
 * Page class
 */
class StatsHourDelete extends StatsHour
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StatsHourDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "statshourdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("statshourlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("statshourlist"); // Return to list
                return;
            }
        }
