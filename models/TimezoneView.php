 ...
 * Page class
 */
class TimezoneView extends Timezone
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TimezoneView";
    ...
    // CSS class/style
    public $CurrentPageName = "timezoneview";
...
// Is modal
        ...
        if (($keyValue = Get("ID") ?? Route("ID")) !== null) {
            ...
            $returnUrl = "timezonelist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("timezonelist"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "timezonelist"; // No matching record, return to list
                    } else {
...
// Load recordset
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("timezonelist"), "", $this->TableVar, true);
        $pageId = "view";
