 ...
 * Page class
 */
class StatsMonthEdit extends StatsMonth
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StatsMonthEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "statsmonthedit";
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        if ($this->Year->CurrentValue != null && $this->Month->CurrentValue != null) {
                            while (!$rs->EOF) {
                                if (SameString($this->Year->CurrentValue, $rs->fields['Year']) && SameString($this->Month->CurrentValue, $rs->fields['Month'])) {
