...
class HelpCategoriesEdit extends HelpCategories
{
    ...
    // Page object name
    public $PageObjName = "HelpCategoriesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "helpcategoriesedit";
                ...
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        if ($this->Category_ID->CurrentValue != null) {
                            while (!$rs->EOF) {
                                if (SameString($this->Category_ID->CurrentValue, $rs->fields['Category_ID'])) {
...
// Get upload files
    ...
    public function renderRow()
    {
        ...
        // Category_ID
        $this->Category_ID->RowCssClass = $this->IsMobileOrModal ? "row" : "";

        // Language
        $this->_Language->RowCssClass = $this->IsMobileOrModal ? "row" : "";

        // Category_Description
        $this->Category_Description->RowCssClass = $this->IsMobileOrModal ? "row" : "";
    ...
    protected function editRow()
    {
        ...
        if ($updateRow) {
            ...
            if ($editRow) {
                $detailPage = Container("HelpGrid");
                if (in_array("help", $detailTblVar) && $detailPage->DetailEdit) {
                    $Security->loadCurrentUserLevel($this->ProjectID . "help"); // Load user level of detail table
