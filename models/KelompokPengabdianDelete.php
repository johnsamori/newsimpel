 ...
 * Page class
 */
class KelompokPengabdianDelete extends KelompokPengabdian
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KelompokPengabdianDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "kelompokpengabdiandelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("kelompokpengabdianlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("kelompokpengabdianlist"); // Return to list
            return;
        }
