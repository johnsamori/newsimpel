...
/**
 * Table class for proposal_penelitian
 */
class ProposalPenelitian extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "proposal_penelitian";
        $this->Dbid = 'DB';
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->Id_kelompok->Lookup = new Lookup('Id_kelompok', 'kelompok_penelitian', false, 'Id_Kelompok', ["Id_Kelompok","Nama_Ketua","",""], '', '', [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`Id_Kelompok`, ''),'" . ValueSeparator(1, $this->Id_kelompok) . "',COALESCE(`Nama_Ketua`,''))");
                break;
            case "id-ID":
                $this->Id_kelompok->Lookup = new Lookup('Id_kelompok', 'kelompok_penelitian', false, 'Id_Kelompok', ["Id_Kelompok","Nama_Ketua","",""], '', '', [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`Id_Kelompok`, ''),'" . ValueSeparator(1, $this->Id_kelompok) . "',COALESCE(`Nama_Ketua`,''))");
                break;
        ...
        $this->Surat_Pernyataan_Tidak_Studi->UploadMaxFileSize = 2000000;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "proposal_penelitian";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("proposalpenelitianlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "proposalpenelitianview") {
            return $Language->phrase("View");
        } elseif ($pageName == "proposalpenelitianedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "proposalpenelitianadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ProposalPenelitianView";
            case Config("API_ADD_ACTION"):
                return "ProposalPenelitianAdd";
            case Config("API_EDIT_ACTION"):
                return "ProposalPenelitianEdit";
            case Config("API_DELETE_ACTION"):
                return "ProposalPenelitianDelete";
            case Config("API_LIST_ACTION"):
                return "ProposalPenelitianList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("proposalpenelitianview", $parm);
        } else {
            $url = $this->keyUrl("proposalpenelitianview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "proposalpenelitianadd?" . $parm;
        } else {
            $url = "proposalpenelitianadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("proposalpenelitianedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("proposalpenelitianlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("proposalpenelitianadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("proposalpenelitianlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("proposalpenelitiandelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "ProposalPenelitianList";
    ...
    public function getUserIDSubquery(&$fld, &$masterfld)
    {
        global $UserTable;
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM proposal_penelitian";
