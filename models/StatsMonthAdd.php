 ...
 * Page class
 */
class StatsMonthAdd extends StatsMonth
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StatsMonthAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "statsmonthadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("statsmonthlist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "statsmonthlist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "statsmonthview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "statsmonthlist") {
                            ...
                            $returnUrl = "statsmonthlist"; // Return list page content
                        }
                    }
