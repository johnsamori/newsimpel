 ...
 * Page class
 */
class BreadcrumblinksView extends Breadcrumblinks
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BreadcrumblinksView";
    ...
    // CSS class/style
    public $CurrentPageName = "breadcrumblinksview";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("Page_Title") ?? Route("Page_Title")) !== null) {
            $this->RecKey["Page_Title"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("Page_Title") ?? Route("Page_Title")) !== null) {
            ...
            $returnUrl = "breadcrumblinkslist"; // Return to list
        }
                ...
                if (!$this->IsModal) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        while (!$this->Recordset->EOF) {
                            if (SameString($this->Page_Title->CurrentValue, $this->Recordset->fields['Page_Title'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "breadcrumblinkslist"; // No matching record, return to list
                    } else {
