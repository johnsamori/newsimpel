 ...
 */
class StatsDate extends DbTable
{
    protected $SqlFrom = "";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "stats_date";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("statsdatelist");
    }
    ...
    {
        global $Language;
        if ($pageName == "statsdateview") {
            return $Language->phrase("View");
        } elseif ($pageName == "statsdateedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "statsdateadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "StatsDateView";
            case Config("API_ADD_ACTION"):
                return "StatsDateAdd";
            case Config("API_EDIT_ACTION"):
                return "StatsDateEdit";
            case Config("API_DELETE_ACTION"):
                return "StatsDateDelete";
            case Config("API_LIST_ACTION"):
                return "StatsDateList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("statsdateview", $parm);
        } else {
            $url = $this->keyUrl("statsdateview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("statsdateedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("statsdatelist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("statsdateadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("statsdatelist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("statsdatedelete");
        }
    }
