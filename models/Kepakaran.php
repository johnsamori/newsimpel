...
/**
 * Table class for kepakaran
 */
class Kepakaran extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->Kepakaran->Nullable = false; // NOT NULL field
        $this->Kepakaran->Required = true; // Required field
        $this->Kepakaran->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "kepakaran";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("kepakaranlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "kepakaranview") {
            return $Language->phrase("View");
        } elseif ($pageName == "kepakaranedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "kepakaranadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "KepakaranView";
            case Config("API_ADD_ACTION"):
                return "KepakaranAdd";
            case Config("API_EDIT_ACTION"):
                return "KepakaranEdit";
            case Config("API_DELETE_ACTION"):
                return "KepakaranDelete";
            case Config("API_LIST_ACTION"):
                return "KepakaranList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("kepakaranview", $parm);
        } else {
            $url = $this->keyUrl("kepakaranview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("kepakaranedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("kepakaranlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("kepakaranadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("kepakaranlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("kepakarandelete");
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        if (!$this->Kepakaran->Raw) {
            $this->Kepakaran->CurrentValue = HtmlDecode($this->Kepakaran->CurrentValue);
        }
        $this->Kepakaran->EditValue = $this->Kepakaran->CurrentValue;
