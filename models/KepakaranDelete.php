 ...
 * Page class
 */
class KepakaranDelete extends Kepakaran
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KepakaranDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "kepakarandelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("kepakaranlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("kepakaranlist"); // Return to list
                return;
            }
        }
