 ...
 * Page class
 */
class LaporanPengabdianAdd extends LaporanPengabdian
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LaporanPengabdianAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "laporanpengabdianadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "laporanpengabdianview") {
...
// Get upload files
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->Laporan->Visible && !$this->Laporan->Upload->KeepFile) {
            $this->Laporan->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->Luaran->Visible && !$this->Luaran->Upload->KeepFile) {
            $this->Luaran->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->Surat_Keterangan_dari_Tempat_Mengabdi->Visible && !$this->Surat_Keterangan_dari_Tempat_Mengabdi->Upload->KeepFile) {
            $this->Surat_Keterangan_dari_Tempat_Mengabdi->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->Dokumentasi->Visible && !$this->Dokumentasi->Upload->KeepFile) {
            $this->Dokumentasi->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->Daftar_Hadir->Visible && !$this->Daftar_Hadir->Upload->KeepFile) {
            $this->Daftar_Hadir->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->Laporan->Visible && !$this->Laporan->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->Laporan->Upload->FileName)) {
                ...
                $this->Laporan->setDbValueDef($rsnew, $this->Laporan->Upload->FileName, false);
            }
        }
        if ($this->Luaran->Visible && !$this->Luaran->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->Luaran->Upload->FileName)) {
                ...
                $this->Luaran->setDbValueDef($rsnew, $this->Luaran->Upload->FileName, false);
            }
        }
        if ($this->Surat_Keterangan_dari_Tempat_Mengabdi->Visible && !$this->Surat_Keterangan_dari_Tempat_Mengabdi->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->Surat_Keterangan_dari_Tempat_Mengabdi->Upload->FileName)) {
                ...
                $this->Surat_Keterangan_dari_Tempat_Mengabdi->setDbValueDef($rsnew, $this->Surat_Keterangan_dari_Tempat_Mengabdi->Upload->FileName, false);
            }
        }
        if ($this->Dokumentasi->Visible && !$this->Dokumentasi->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->Dokumentasi->Upload->FileName)) {
                ...
                $this->Dokumentasi->setDbValueDef($rsnew, $this->Dokumentasi->Upload->FileName, false);
            }
        }
        if ($this->Daftar_Hadir->Visible && !$this->Daftar_Hadir->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->Daftar_Hadir->Upload->FileName)) {
                ...
                $this->Daftar_Hadir->setDbValueDef($rsnew, $this->Daftar_Hadir->Upload->FileName, false);
            }
        }
