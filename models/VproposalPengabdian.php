...
/**
 * Table class for vproposal_pengabdian
 */
class VproposalPengabdian extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "vproposal_pengabdian";
        $this->Dbid = 'DB';
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "vproposal_pengabdian";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("vproposalpengabdianlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "vproposalpengabdianview") {
            return $Language->phrase("View");
        } elseif ($pageName == "vproposalpengabdianedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "vproposalpengabdianadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VproposalPengabdianView";
            case Config("API_ADD_ACTION"):
                return "VproposalPengabdianAdd";
            case Config("API_EDIT_ACTION"):
                return "VproposalPengabdianEdit";
            case Config("API_DELETE_ACTION"):
                return "VproposalPengabdianDelete";
            case Config("API_LIST_ACTION"):
                return "VproposalPengabdianList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("vproposalpengabdianview", $parm);
        } else {
            $url = $this->keyUrl("vproposalpengabdianview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "vproposalpengabdianadd?" . $parm;
        } else {
            $url = "vproposalpengabdianadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vproposalpengabdianedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vproposalpengabdianlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vproposalpengabdianadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vproposalpengabdianlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("vproposalpengabdiandelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "VproposalPengabdianList";
