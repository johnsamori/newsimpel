 ...
 * Page class
 */
class KepakaranAdd extends Kepakaran
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KepakaranAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "kepakaranadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("kepakaranlist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "kepakaranlist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "kepakaranview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "kepakaranlist") {
                            ...
                            $returnUrl = "kepakaranlist"; // Return list page content
                        }
                    }
...
// Get upload files
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->Kepakaran->EditValue = HtmlEncode($this->Kepakaran->CurrentValue);
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Kepakaran
        $this->Kepakaran->setDbValueDef($rsnew, $this->Kepakaran->CurrentValue, false);
