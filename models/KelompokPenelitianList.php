 ...
 * Page class
 */
class KelompokPenelitianList extends KelompokPenelitian
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KelompokPenelitianList";
    ...
    public $FormName = "fkelompok_penelitianlist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "kelompokpenelitianlist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "kelompokpenelitianadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "kelompokpenelitiandelete";
        $this->MultiUpdateUrl = "kelompokpenelitianupdate";
...
// Is modal
        ...
        if ($this->IsModal) {
            $this->FormName = "fkelompok_penelitiangrid";
        }
		...
		if (@$_COOKIE['kelompok_penelitian_searchpanel'] == 'notactive') {
			RemoveClass($this->SearchPanelClass, "show");
			AppendClass($this->SearchPanelClass, "collapse");
		} elseif (@$_COOKIE['kelompok_penelitian_searchpanel'] == 'active') {
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fkelompok_penelitiansrch");
        }
        $filterList = Concat($filterList, $this->Id_Kelompok->AdvancedSearch->toJson(), ","); // Field Id_Kelompok
        $filterList = Concat($filterList, $this->Nama_Ketua->AdvancedSearch->toJson(), ","); // Field Nama_Ketua
        $filterList = Concat($filterList, $this->Nama_Anggota_1->AdvancedSearch->toJson(), ","); // Field Nama_Anggota_1
        $filterList = Concat($filterList, $this->Nama_Anggota_2->AdvancedSearch->toJson(), ","); // Field Nama_Anggota_2
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fkelompok_penelitiansrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field Nama_Ketua
        $this->Nama_Ketua->AdvancedSearch->SearchValue = @$filter["x_Nama_Ketua"];
        $this->Nama_Ketua->AdvancedSearch->SearchOperator = @$filter["z_Nama_Ketua"];
        $this->Nama_Ketua->AdvancedSearch->SearchCondition = @$filter["v_Nama_Ketua"];
        $this->Nama_Ketua->AdvancedSearch->SearchValue2 = @$filter["y_Nama_Ketua"];
        $this->Nama_Ketua->AdvancedSearch->SearchOperator2 = @$filter["w_Nama_Ketua"];
        $this->Nama_Ketua->AdvancedSearch->save();

        // Field Nama_Anggota_1
        $this->Nama_Anggota_1->AdvancedSearch->SearchValue = @$filter["x_Nama_Anggota_1"];
        $this->Nama_Anggota_1->AdvancedSearch->SearchOperator = @$filter["z_Nama_Anggota_1"];
        $this->Nama_Anggota_1->AdvancedSearch->SearchCondition = @$filter["v_Nama_Anggota_1"];
        $this->Nama_Anggota_1->AdvancedSearch->SearchValue2 = @$filter["y_Nama_Anggota_1"];
        $this->Nama_Anggota_1->AdvancedSearch->SearchOperator2 = @$filter["w_Nama_Anggota_1"];
        $this->Nama_Anggota_1->AdvancedSearch->save();

        // Field Nama_Anggota_2
        $this->Nama_Anggota_2->AdvancedSearch->SearchValue = @$filter["x_Nama_Anggota_2"];
        $this->Nama_Anggota_2->AdvancedSearch->SearchOperator = @$filter["z_Nama_Anggota_2"];
        $this->Nama_Anggota_2->AdvancedSearch->SearchCondition = @$filter["v_Nama_Anggota_2"];
        $this->Nama_Anggota_2->AdvancedSearch->SearchValue2 = @$filter["y_Nama_Anggota_2"];
        $this->Nama_Anggota_2->AdvancedSearch->SearchOperator2 = @$filter["w_Nama_Anggota_2"];
        $this->Nama_Anggota_2->AdvancedSearch->save();
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        $searchFlds[] = &$this->Nama_Ketua;
        $searchFlds[] = &$this->Nama_Anggota_1;
        $searchFlds[] = &$this->Nama_Anggota_2;
        $searchFlds[] = &$this->IP;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->Nama_Ketua); // Nama_Ketua
            $this->updateSort($this->Nama_Anggota_1); // Nama_Anggota_1
            $this->updateSort($this->Nama_Anggota_2); // Nama_Anggota_2
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->Nama_Ketua->setSort("");
                $this->Nama_Anggota_1->setSort("");
                $this->Nama_Anggota_2->setSort("");
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView() && $this->showOptionLink("view")) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"kelompok_penelitian\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($Security->canEdit() && $this->showOptionLink("edit")) {
                if ($this->ModalEdit && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"kelompok_penelitian\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-ask=\"1\" data-btn=\"SaveBtn\">" . $Language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($Security->canAdd() && $this->showOptionLink("add")) {
                if ($this->ModalAdd && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"kelompok_penelitian\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $Language->phrase("CopyLink") . "</a>";
                } else {
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fkelompok_penelitianlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . " " . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fkelompok_penelitianlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . " " . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
			$item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"kelompok_penelitian\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        $item->Body = "<button type=\"button\" class=\"ew-action ew-multi-delete\" title=\"" .
            ...
            HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" form=\"fkelompok_penelitianlist\"" .
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("Nama_Ketua", $this->createColumnOption("Nama_Ketua"));
            $option->add("Nama_Anggota_1", $this->createColumnOption("Nama_Anggota_1"));
            $option->add("Nama_Anggota_2", $this->createColumnOption("Nama_Anggota_2"));
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fkelompok_penelitiansrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fkelompok_penelitiansrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fkelompok_penelitianlist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_kelompok_penelitian", "data-rowtype" => ROWTYPE_ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_kelompok_penelitian",
...
// Load basic search values
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fkelompok_penelitianlist" data-ew-action="email" data-custom="false" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
		...
		if (@$_COOKIE['kelompok_penelitian_searchpanel'] == 'notactive') {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fkelompok_penelitiansrch\" aria-pressed=\"false\">" . $Language->phrase("SearchLink") . "</a>";
		} else {
			// $item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fkelompok_penelitiansrch\" aria-pressed=\"false\">" . $Language->phrase("SearchLink") . "</a>";
			$item->Body = "<a class=\"btn btn-default ew-search-toggle active\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fkelompok_penelitiansrch\" aria-pressed=\"true\">" . $Language->phrase("SearchLink") . "</a>";
		}
        $item->Visible = true;
