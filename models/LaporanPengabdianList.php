 ...
 * Page class
 */
class LaporanPengabdianList extends LaporanPengabdian
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LaporanPengabdianList";
    ...
    public $FormName = "flaporan_pengabdianlist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "laporanpengabdianlist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "laporanpengabdianadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "laporanpengabdiandelete";
        $this->MultiUpdateUrl = "laporanpengabdianupdate";
    ...
    // Begin modification by Masino Sinaga, September 18, 2020
    // public $RecordRange = 10;
	public $RecordRange = 10;

	// End modification by Masino Sinaga, September 18, 2020
...
// Is modal
        ...
        if ($this->IsModal) {
            $this->FormName = "flaporan_pengabdiangrid";
        }
		...
		if (@$_COOKIE['laporan_pengabdian_searchpanel'] == 'notactive') {
			RemoveClass($this->SearchPanelClass, "show");
			AppendClass($this->SearchPanelClass, "collapse");
		} elseif (@$_COOKIE['laporan_pengabdian_searchpanel'] == 'active') {
		...
		// Set up first record for Export Data purpose, by Masino Sinaga, February 20, 2021
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "flaporan_pengabdiansrch");
        }
        $filterList = Concat($filterList, $this->Id_kelompok->AdvancedSearch->toJson(), ","); // Field Id_kelompok
        $filterList = Concat($filterList, $this->Lembar_Pengesahan->AdvancedSearch->toJson(), ","); // Field Lembar_Pengesahan
        $filterList = Concat($filterList, $this->Laporan->AdvancedSearch->toJson(), ","); // Field Laporan
        $filterList = Concat($filterList, $this->Luaran->AdvancedSearch->toJson(), ","); // Field Luaran
        $filterList = Concat($filterList, $this->Surat_Keterangan_dari_Tempat_Mengabdi->AdvancedSearch->toJson(), ","); // Field Surat_Keterangan_dari_Tempat_Mengabdi
        $filterList = Concat($filterList, $this->Dokumentasi->AdvancedSearch->toJson(), ","); // Field Dokumentasi
        $filterList = Concat($filterList, $this->Daftar_Hadir->AdvancedSearch->toJson(), ","); // Field Daftar_Hadir
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "flaporan_pengabdiansrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field Luaran
        $this->Luaran->AdvancedSearch->SearchValue = @$filter["x_Luaran"];
        $this->Luaran->AdvancedSearch->SearchOperator = @$filter["z_Luaran"];
        $this->Luaran->AdvancedSearch->SearchCondition = @$filter["v_Luaran"];
        $this->Luaran->AdvancedSearch->SearchValue2 = @$filter["y_Luaran"];
        $this->Luaran->AdvancedSearch->SearchOperator2 = @$filter["w_Luaran"];
        $this->Luaran->AdvancedSearch->save();

        // Field Surat_Keterangan_dari_Tempat_Mengabdi
        $this->Surat_Keterangan_dari_Tempat_Mengabdi->AdvancedSearch->SearchValue = @$filter["x_Surat_Keterangan_dari_Tempat_Mengabdi"];
        $this->Surat_Keterangan_dari_Tempat_Mengabdi->AdvancedSearch->SearchOperator = @$filter["z_Surat_Keterangan_dari_Tempat_Mengabdi"];
        $this->Surat_Keterangan_dari_Tempat_Mengabdi->AdvancedSearch->SearchCondition = @$filter["v_Surat_Keterangan_dari_Tempat_Mengabdi"];
        $this->Surat_Keterangan_dari_Tempat_Mengabdi->AdvancedSearch->SearchValue2 = @$filter["y_Surat_Keterangan_dari_Tempat_Mengabdi"];
        $this->Surat_Keterangan_dari_Tempat_Mengabdi->AdvancedSearch->SearchOperator2 = @$filter["w_Surat_Keterangan_dari_Tempat_Mengabdi"];
        $this->Surat_Keterangan_dari_Tempat_Mengabdi->AdvancedSearch->save();

        // Field Dokumentasi
        $this->Dokumentasi->AdvancedSearch->SearchValue = @$filter["x_Dokumentasi"];
        $this->Dokumentasi->AdvancedSearch->SearchOperator = @$filter["z_Dokumentasi"];
        $this->Dokumentasi->AdvancedSearch->SearchCondition = @$filter["v_Dokumentasi"];
        $this->Dokumentasi->AdvancedSearch->SearchValue2 = @$filter["y_Dokumentasi"];
        $this->Dokumentasi->AdvancedSearch->SearchOperator2 = @$filter["w_Dokumentasi"];
        $this->Dokumentasi->AdvancedSearch->save();

        // Field Daftar_Hadir
        $this->Daftar_Hadir->AdvancedSearch->SearchValue = @$filter["x_Daftar_Hadir"];
        $this->Daftar_Hadir->AdvancedSearch->SearchOperator = @$filter["z_Daftar_Hadir"];
        $this->Daftar_Hadir->AdvancedSearch->SearchCondition = @$filter["v_Daftar_Hadir"];
        $this->Daftar_Hadir->AdvancedSearch->SearchValue2 = @$filter["y_Daftar_Hadir"];
        $this->Daftar_Hadir->AdvancedSearch->SearchOperator2 = @$filter["w_Daftar_Hadir"];
        $this->Daftar_Hadir->AdvancedSearch->save();
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->Id_kelompok;
        $searchFlds[] = &$this->Lembar_Pengesahan;
        $searchFlds[] = &$this->Laporan;
        $searchFlds[] = &$this->Luaran;
        $searchFlds[] = &$this->Surat_Keterangan_dari_Tempat_Mengabdi;
        $searchFlds[] = &$this->Dokumentasi;
        $searchFlds[] = &$this->Daftar_Hadir;
        $searchFlds[] = &$this->IP;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->Id_kelompok); // Id_kelompok
            $this->updateSort($this->Lembar_Pengesahan); // Lembar_Pengesahan
            $this->updateSort($this->Laporan); // Laporan
            $this->updateSort($this->Luaran); // Luaran
            $this->updateSort($this->Surat_Keterangan_dari_Tempat_Mengabdi); // Surat_Keterangan_dari_Tempat_Mengabdi
            $this->updateSort($this->Dokumentasi); // Dokumentasi
            $this->updateSort($this->Daftar_Hadir); // Daftar_Hadir
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->Luaran->setSort("");
                $this->Surat_Keterangan_dari_Tempat_Mengabdi->setSort("");
                $this->Dokumentasi->setSort("");
                $this->Daftar_Hadir->setSort("");
    ...
    public function renderListOptions()
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView() && $this->showOptionLink("view")) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"laporan_pengabdian\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($Security->canEdit() && $this->showOptionLink("edit")) {
                if ($this->ModalEdit && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"laporan_pengabdian\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-ask=\"1\" data-btn=\"SaveBtn\">" . $Language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($Security->canAdd() && $this->showOptionLink("add")) {
                if ($this->ModalAdd && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"laporan_pengabdian\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $Language->phrase("CopyLink") . "</a>";
                } else {
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"flaporan_pengabdianlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . " " . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"flaporan_pengabdianlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . " " . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->Id_kelompok->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
			$item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"laporan_pengabdian\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        $item->Body = "<button type=\"button\" class=\"ew-action ew-multi-delete\" title=\"" .
            ...
            HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" form=\"flaporan_pengabdianlist\"" .
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("Id_kelompok", $this->createColumnOption("Id_kelompok"));
            $option->add("Lembar_Pengesahan", $this->createColumnOption("Lembar_Pengesahan"));
            $option->add("Laporan", $this->createColumnOption("Laporan"));
            $option->add("Luaran", $this->createColumnOption("Luaran"));
            $option->add("Surat_Keterangan_dari_Tempat_Mengabdi", $this->createColumnOption("Surat_Keterangan_dari_Tempat_Mengabdi"));
            $option->add("Dokumentasi", $this->createColumnOption("Dokumentasi"));
            $option->add("Daftar_Hadir", $this->createColumnOption("Daftar_Hadir"));
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"flaporan_pengabdiansrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"flaporan_pengabdiansrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="flaporan_pengabdianlist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_laporan_pengabdian", "data-rowtype" => ROWTYPE_ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_laporan_pengabdian",
...
// Load basic search values
    ...
    protected function setupSearchOptions()
    {
		...
		if (@$_COOKIE['laporan_pengabdian_searchpanel'] == 'notactive') {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"flaporan_pengabdiansrch\" aria-pressed=\"false\">" . $Language->phrase("SearchLink") . "</a>";
		} else {
			// $item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"flaporan_pengabdiansrch\" aria-pressed=\"false\">" . $Language->phrase("SearchLink") . "</a>";
			$item->Body = "<a class=\"btn btn-default ew-search-toggle active\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"flaporan_pengabdiansrch\" aria-pressed=\"true\">" . $Language->phrase("SearchLink") . "</a>";
		}
        $item->Visible = true;
