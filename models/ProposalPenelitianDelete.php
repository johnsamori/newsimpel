 ...
 * Page class
 */
class ProposalPenelitianDelete extends ProposalPenelitian
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProposalPenelitianDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "proposalpenelitiandelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("proposalpenelitianlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("proposalpenelitianlist"); // Return to list
            return;
        }
