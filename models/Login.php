...
// Is modal
		...
		// Begin of modification by Masino Sinaga, September 24, 2022 
		...
		// End of modification by Masino Sinaga, September 24, 2022 
            ...
            if ($validate) {
                ...
                if ($validate) {
                    ...
                    // Check concurrent user login
                        ...
                        $message = str_replace("%u", $this->Username->CurrentValue, $Language->phrase("UserAlreadyLoggedIn")); // change phrase UserLoggedIn to UserAlreadyLoggedIn, by Masino Sinaga, October 19, 2022
						// Begin of modification auto-remove session by Masino Sinaga, October 19, 2022
						$UserProfile->setValue(Config("USER_PROFILE_SESSION_ID"), session_id()); // Use current Session ID
						$UserProfile->saveProfileToDatabase($this->Username->CurrentValue); // Save profile
						// End of modification auto-remove session by Masino Sinaga, October 19, 2022
                        if ($this->IsModal) {
    ...
    {
        Config("MS_ENTER_MOVING_CURSOR_TO_NEXT_FIELD", FALSE);
    }
