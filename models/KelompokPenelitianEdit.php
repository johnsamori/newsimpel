 ...
 * Page class
 */
class KelompokPenelitianEdit extends KelompokPenelitian
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KelompokPenelitianEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "kelompokpenelitianedit";
...
// Get upload files
    ...
    protected function editRow()
    {
        ...
        // Check field with unique index (Nama_Anggota_1)
        if ($this->Nama_Anggota_1->CurrentValue != "") {
            $filterChk = "(`Nama_Anggota_1` = '" . AdjustSql($this->Nama_Anggota_1->CurrentValue, $this->Dbid) . "')";
            $filterChk .= " AND NOT (" . $filter . ")";
            $this->CurrentFilter = $filterChk;
            $sqlChk = $this->getCurrentSql();
            $rsChk = $conn->executeQuery($sqlChk);
