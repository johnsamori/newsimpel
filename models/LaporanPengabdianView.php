 ...
 * Page class
 */
class LaporanPengabdianView extends LaporanPengabdian
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LaporanPengabdianView";
    ...
    // CSS class/style
    public $CurrentPageName = "laporanpengabdianview";
...
// Is modal
        ...
        if (($keyValue = Get("Id_kelompok") ?? Route("Id_kelompok")) !== null) {
            ...
            $returnUrl = "laporanpengabdianlist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "laporanpengabdianlist"; // No matching record, return to list
                    } else {
...
// Load recordset
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="flaporan_pengabdianview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . HtmlEncode(ArrayToJsonAttribute($this->RecKey)) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
