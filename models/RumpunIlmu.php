...
/**
 * Table class for rumpun_ilmu
 */
class RumpunIlmu extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->Rumpun_Ilmu->Nullable = false; // NOT NULL field
        $this->Rumpun_Ilmu->Required = true; // Required field
        $this->Rumpun_Ilmu->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "rumpun_ilmu";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("rumpunilmulist");
    }
    ...
    {
        global $Language;
        if ($pageName == "rumpunilmuview") {
            return $Language->phrase("View");
        } elseif ($pageName == "rumpunilmuedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "rumpunilmuadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "RumpunIlmuView";
            case Config("API_ADD_ACTION"):
                return "RumpunIlmuAdd";
            case Config("API_EDIT_ACTION"):
                return "RumpunIlmuEdit";
            case Config("API_DELETE_ACTION"):
                return "RumpunIlmuDelete";
            case Config("API_LIST_ACTION"):
                return "RumpunIlmuList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("rumpunilmuview", $parm);
        } else {
            $url = $this->keyUrl("rumpunilmuview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("rumpunilmuedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("rumpunilmulist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("rumpunilmuadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("rumpunilmulist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("rumpunilmudelete");
        }
    }
