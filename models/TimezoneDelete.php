 ...
 * Page class
 */
class TimezoneDelete extends Timezone
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TimezoneDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "timezonedelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("timezonelist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("timezonelist"); // Return to list
                return;
            }
        }
