                ...
                if (!$this->IsModal) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        while (!$this->Recordset->EOF) {
                            if (SameString($this->User_Level_ID->CurrentValue, $this->Recordset->fields['User_Level_ID']) && SameString($this->Table_Name->CurrentValue, $this->Recordset->fields['Table_Name'])) {
