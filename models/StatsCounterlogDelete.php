 ...
 * Page class
 */
class StatsCounterlogDelete extends StatsCounterlog
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StatsCounterlogDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "statscounterlogdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("statscounterloglist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("statscounterloglist"); // Return to list
                return;
            }
        }
