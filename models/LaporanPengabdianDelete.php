 ...
 * Page class
 */
class LaporanPengabdianDelete extends LaporanPengabdian
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LaporanPengabdianDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "laporanpengabdiandelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("laporanpengabdianlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("laporanpengabdianlist"); // Return to list
            return;
        }
