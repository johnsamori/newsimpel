 ...
 * Page class
 */
class ProposalPengabdianStatusDelete extends ProposalPengabdianStatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProposalPengabdianStatusDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "proposalpengabdianstatusdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("proposalpengabdianstatuslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("proposalpengabdianstatuslist"); // Return to list
                return;
            }
        }
