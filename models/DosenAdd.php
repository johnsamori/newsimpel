...
class DosenAdd extends Dosen
{
    ...
    // CSS class/style
    public $CurrentPageName = "dosenadd";
...
// Get upload files
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Id_Sinta
        $this->Id_Sinta->setDbValueDef($rsnew, $this->Id_Sinta->CurrentValue, false);
        ...
        // Program_Studi
        $this->Program_Studi->setDbValueDef($rsnew, $this->Program_Studi->CurrentValue, false);

        // Jenjang_Pendidikan
        $this->Jenjang_Pendidikan->setDbValueDef($rsnew, $this->Jenjang_Pendidikan->CurrentValue, false);

        // Jabatan_Fungsional
        $this->Jabatan_Fungsional->setDbValueDef($rsnew, $this->Jabatan_Fungsional->CurrentValue, false);
        ...
        // Validasi
        $this->Validasi->setDbValueDef($rsnew, $this->Validasi->CurrentValue, false);
