...
class HelpGrid extends Help
{
    ...
    public $FormName = "fhelpgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "helpgrid";
...
// Use layout
    ...
    {
        global $CurrentForm;
        if ($CurrentForm->hasValue("x__Language") && $CurrentForm->hasValue("o__Language") && $this->_Language->CurrentValue != $this->_Language->DefaultValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_Topic") && $CurrentForm->hasValue("o_Topic") && $this->Topic->CurrentValue != $this->Topic->DefaultValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_Category") && $CurrentForm->hasValue("o_Category") && $this->Category->CurrentValue != $this->Category->DefaultValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_Order") && $CurrentForm->hasValue("o_Order") && $this->Order->CurrentValue != $this->Order->DefaultValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_Display_in_Page") && $CurrentForm->hasValue("o_Display_in_Page") && $this->Display_in_Page->CurrentValue != $this->Display_in_Page->DefaultValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_Updated_By") && $CurrentForm->hasValue("o_Updated_By") && $this->Updated_By->CurrentValue != $this->Updated_By->DefaultValue) {
            return false;
        }
...
// Get upload files
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o__Language")) {
            $this->_Language->setOldValue($CurrentForm->getValue("o__Language"));
        }
        ...
        if ($CurrentForm->hasValue("o_Topic")) {
            $this->Topic->setOldValue($CurrentForm->getValue("o_Topic"));
        }
        ...
        if ($CurrentForm->hasValue("o_Display_in_Page")) {
            $this->Display_in_Page->setOldValue($CurrentForm->getValue("o_Display_in_Page"));
        }
        ...
        if ($CurrentForm->hasValue("o_Updated_By")) {
            $this->Updated_By->setOldValue($CurrentForm->getValue("o_Updated_By"));
        }
