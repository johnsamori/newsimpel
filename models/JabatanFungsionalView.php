 ...
 * Page class
 */
class JabatanFungsionalView extends JabatanFungsional
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JabatanFungsionalView";
    ...
    // CSS class/style
    public $CurrentPageName = "jabatanfungsionalview";
...
// Is modal
        ...
        if (($keyValue = Get("no") ?? Route("no")) !== null) {
            ...
            $returnUrl = "jabatanfungsionallist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("jabatanfungsionallist"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "jabatanfungsionallist"; // No matching record, return to list
                    } else {
...
// Load recordset
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("jabatanfungsionallist"), "", $this->TableVar, true);
        $pageId = "view";
