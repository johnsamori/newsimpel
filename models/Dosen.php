...
class Dosen extends DbTable
{
    ...
    public function __construct()
    {
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->Jenis_Kelamin->Lookup = new Lookup('Jenis_Kelamin', 'dosen', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
                break;
            case "id-ID":
                $this->Jenis_Kelamin->Lookup = new Lookup('Jenis_Kelamin', 'dosen', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
                break;
        ...
        $this->Rumpun_Ilmu->setSelectMultiple(false); // Select one
        $this->Rumpun_Ilmu->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->Rumpun_Ilmu->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en-US":
                $this->Rumpun_Ilmu->Lookup = new Lookup('Rumpun_Ilmu', 'rumpun_ilmu', false, 'Rumpun_Ilmu', ["Rumpun_Ilmu","","",""], '', '', [], [], [], [], [], [], '', '', "`Rumpun_Ilmu`");
                break;
            case "id-ID":
                $this->Rumpun_Ilmu->Lookup = new Lookup('Rumpun_Ilmu', 'rumpun_ilmu', false, 'Rumpun_Ilmu', ["Rumpun_Ilmu","","",""], '', '', [], [], [], [], [], [], '', '', "`Rumpun_Ilmu`");
                break;
        ...
        $this->Rumpun_Ilmu->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->Aktif->Lookup = new Lookup('Aktif', 'dosen', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
                break;
            case "id-ID":
                $this->Aktif->Lookup = new Lookup('Aktif', 'dosen', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->Validasi->Lookup = new Lookup('Validasi', 'dosen', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
                break;
            case "id-ID":
                $this->Validasi->Lookup = new Lookup('Validasi', 'dosen', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
                break;
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("dosenlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "dosenview") {
            return $Language->phrase("View");
        } elseif ($pageName == "dosenedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "dosenadd") {
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("dosendelete");
        }
    }
