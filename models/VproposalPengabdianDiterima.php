...
/**
 * Table class for vproposal_pengabdian_diterima
 */
class VproposalPengabdianDiterima extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "vproposal_pengabdian_diterima";
        $this->Dbid = 'DB';
        ...
        $this->Nama_Anggota_2->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->Status->Lookup = new Lookup('Status', 'vproposal_pengabdian_diterima', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
                break;
            case "id-ID":
                $this->Status->Lookup = new Lookup('Status', 'vproposal_pengabdian_diterima', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
                break;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "vproposal_pengabdian_diterima";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("vproposalpengabdianditerimalist");
    }
    ...
    {
        global $Language;
        if ($pageName == "vproposalpengabdianditerimaview") {
            return $Language->phrase("View");
        } elseif ($pageName == "vproposalpengabdianditerimaedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "vproposalpengabdianditerimaadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VproposalPengabdianDiterimaView";
            case Config("API_ADD_ACTION"):
                return "VproposalPengabdianDiterimaAdd";
            case Config("API_EDIT_ACTION"):
                return "VproposalPengabdianDiterimaEdit";
            case Config("API_DELETE_ACTION"):
                return "VproposalPengabdianDiterimaDelete";
            case Config("API_LIST_ACTION"):
                return "VproposalPengabdianDiterimaList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("vproposalpengabdianditerimaview", $parm);
        } else {
            $url = $this->keyUrl("vproposalpengabdianditerimaview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "vproposalpengabdianditerimaadd?" . $parm;
        } else {
            $url = "vproposalpengabdianditerimaadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vproposalpengabdianditerimaedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vproposalpengabdianditerimalist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vproposalpengabdianditerimaadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vproposalpengabdianditerimalist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("vproposalpengabdianditerimadelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "VproposalPengabdianDiterimaList";
