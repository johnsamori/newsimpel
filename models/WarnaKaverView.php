 ...
 * Page class
 */
class WarnaKaverView extends WarnaKaver
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WarnaKaverView";
    ...
    // CSS class/style
    public $CurrentPageName = "warnakaverview";
...
// Is modal
        ...
        if (($keyValue = Get("id_kaver") ?? Route("id_kaver")) !== null) {
            ...
            $this->RecKey["id_kaver"] = $this->id_kaver->QueryStringValue;
        } elseif (Post("id_kaver") !== null) {
            $this->id_kaver->setFormValue(Post("id_kaver"));
            $this->RecKey["id_kaver"] = $this->id_kaver->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->id_kaver->setQueryStringValue($keyValue);
            $this->RecKey["id_kaver"] = $this->id_kaver->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "warnakaverlist"; // Return to list
        }
                ...
                if (!$this->IsModal) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        while (!$this->Recordset->EOF) {
                            if (SameString($this->id_kaver->CurrentValue, $this->Recordset->fields['id_kaver'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "warnakaverlist"; // No matching record, return to list
                    } else {
