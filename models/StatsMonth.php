 ...
 */
class StatsMonth extends DbTable
{
    protected $SqlFrom = "";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "stats_month";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("statsmonthlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "statsmonthview") {
            return $Language->phrase("View");
        } elseif ($pageName == "statsmonthedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "statsmonthadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "StatsMonthAdd";
            case Config("API_EDIT_ACTION"):
                return "StatsMonthEdit";
            case Config("API_DELETE_ACTION"):
                return "StatsMonthDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("statsmonthview", $parm);
        } else {
            $url = $this->keyUrl("statsmonthview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("statsmonthedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("statsmonthlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("statsmonthadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("statsmonthlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("statsmonthdelete");
        }
    }
