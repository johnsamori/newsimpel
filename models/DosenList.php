...
class DosenList extends Dosen
{
    ...
    public $FormName = "fdosenlist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "dosenlist";
...
// Is modal
		...
		if (@$_COOKIE['dosen_searchpanel'] == 'notactive') {
			RemoveClass($this->SearchPanelClass, "show");
			AppendClass($this->SearchPanelClass, "collapse");
		} elseif (@$_COOKIE['dosen_searchpanel'] == 'active') {
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fdosensrch");
        }
        $filterList = Concat($filterList, $this->NIDN->AdvancedSearch->toJson(), ","); // Field NIDN
        $filterList = Concat($filterList, $this->Id_Sinta->AdvancedSearch->toJson(), ","); // Field Id_Sinta
        ...
        $filterList = Concat($filterList, $this->Jenjang_Pendidikan->AdvancedSearch->toJson(), ","); // Field Jenjang_Pendidikan
        $filterList = Concat($filterList, $this->Jabatan_Fungsional->AdvancedSearch->toJson(), ","); // Field Jabatan_Fungsional
        $filterList = Concat($filterList, $this->Kepakaran->AdvancedSearch->toJson(), ","); // Field Kepakaran
        $filterList = Concat($filterList, $this->Rumpun_Ilmu->AdvancedSearch->toJson(), ","); // Field Rumpun_Ilmu
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fdosensrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field Id_Sinta
        $this->Id_Sinta->AdvancedSearch->SearchValue = @$filter["x_Id_Sinta"];
        $this->Id_Sinta->AdvancedSearch->SearchOperator = @$filter["z_Id_Sinta"];
        $this->Id_Sinta->AdvancedSearch->SearchCondition = @$filter["v_Id_Sinta"];
        $this->Id_Sinta->AdvancedSearch->SearchValue2 = @$filter["y_Id_Sinta"];
        $this->Id_Sinta->AdvancedSearch->SearchOperator2 = @$filter["w_Id_Sinta"];
        $this->Id_Sinta->AdvancedSearch->save();
        ...
        $this->Jenjang_Pendidikan->AdvancedSearch->SearchValue = @$filter["x_Jenjang_Pendidikan"];
        $this->Jenjang_Pendidikan->AdvancedSearch->SearchOperator = @$filter["z_Jenjang_Pendidikan"];
        $this->Jenjang_Pendidikan->AdvancedSearch->SearchCondition = @$filter["v_Jenjang_Pendidikan"];
        $this->Jenjang_Pendidikan->AdvancedSearch->SearchValue2 = @$filter["y_Jenjang_Pendidikan"];
        $this->Jenjang_Pendidikan->AdvancedSearch->SearchOperator2 = @$filter["w_Jenjang_Pendidikan"];
        $this->Jenjang_Pendidikan->AdvancedSearch->save();

        // Field Jabatan_Fungsional
        $this->Jabatan_Fungsional->AdvancedSearch->SearchValue = @$filter["x_Jabatan_Fungsional"];
        $this->Jabatan_Fungsional->AdvancedSearch->SearchOperator = @$filter["z_Jabatan_Fungsional"];
        $this->Jabatan_Fungsional->AdvancedSearch->SearchCondition = @$filter["v_Jabatan_Fungsional"];
        $this->Jabatan_Fungsional->AdvancedSearch->SearchValue2 = @$filter["y_Jabatan_Fungsional"];
        $this->Jabatan_Fungsional->AdvancedSearch->SearchOperator2 = @$filter["w_Jabatan_Fungsional"];
        $this->Jabatan_Fungsional->AdvancedSearch->save();

        // Field Kepakaran
        $this->Kepakaran->AdvancedSearch->SearchValue = @$filter["x_Kepakaran"];
        $this->Kepakaran->AdvancedSearch->SearchOperator = @$filter["z_Kepakaran"];
        $this->Kepakaran->AdvancedSearch->SearchCondition = @$filter["v_Kepakaran"];
        $this->Kepakaran->AdvancedSearch->SearchValue2 = @$filter["y_Kepakaran"];
        $this->Kepakaran->AdvancedSearch->SearchOperator2 = @$filter["w_Kepakaran"];
        $this->Kepakaran->AdvancedSearch->save();

        // Field Rumpun_Ilmu
        $this->Rumpun_Ilmu->AdvancedSearch->SearchValue = @$filter["x_Rumpun_Ilmu"];
        $this->Rumpun_Ilmu->AdvancedSearch->SearchOperator = @$filter["z_Rumpun_Ilmu"];
        $this->Rumpun_Ilmu->AdvancedSearch->SearchCondition = @$filter["v_Rumpun_Ilmu"];
        $this->Rumpun_Ilmu->AdvancedSearch->SearchValue2 = @$filter["y_Rumpun_Ilmu"];
        $this->Rumpun_Ilmu->AdvancedSearch->SearchOperator2 = @$filter["w_Rumpun_Ilmu"];
        $this->Rumpun_Ilmu->AdvancedSearch->save();
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        $searchFlds[] = &$this->Jenjang_Pendidikan;
        $searchFlds[] = &$this->Jabatan_Fungsional;
        $searchFlds[] = &$this->Kepakaran;
        $searchFlds[] = &$this->Rumpun_Ilmu;
        $searchFlds[] = &$this->Aktif;
        $searchFlds[] = &$this->Validasi;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->Id_Sinta); // Id_Sinta
            ...
            $this->updateSort($this->Jenjang_Pendidikan); // Jenjang_Pendidikan
            $this->updateSort($this->Jabatan_Fungsional); // Jabatan_Fungsional
            $this->updateSort($this->Kepakaran); // Kepakaran
            $this->updateSort($this->Rumpun_Ilmu); // Rumpun_Ilmu
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->NIDN->setSort("");
                $this->Id_Sinta->setSort("");
                $this->Nama_Lengkap->setSort("");
                $this->Alamat->setSort("");
                $this->_Email->setSort("");
                $this->Jenis_Kelamin->setSort("");
                $this->Program_Studi->setSort("");
                $this->Jenjang_Pendidikan->setSort("");
                $this->Jabatan_Fungsional->setSort("");
                $this->Kepakaran->setSort("");
                $this->Rumpun_Ilmu->setSort("");
                $this->Aktif->setSort("");
    ...
    public function renderListOptions()
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"dosen\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($Security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"dosen\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-ask=\"1\" data-btn=\"SaveBtn\">" . $Language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($Security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"dosen\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $Language->phrase("CopyLink") . "</a>";
                } else {
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fdosenlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . " " . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fdosenlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . " " . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->NIDN->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
			$item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"dosen\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        $item->Body = "<button type=\"button\" class=\"ew-action ew-multi-delete\" title=\"" .
            ...
            HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" form=\"fdosenlist\"" .
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("NIDN", $this->createColumnOption("NIDN"));
            $option->add("Id_Sinta", $this->createColumnOption("Id_Sinta"));
            $option->add("Nama_Lengkap", $this->createColumnOption("Nama_Lengkap"));
            $option->add("Alamat", $this->createColumnOption("Alamat"));
            $option->add("Email", $this->createColumnOption("Email"));
            $option->add("Jenis_Kelamin", $this->createColumnOption("Jenis_Kelamin"));
            $option->add("Program_Studi", $this->createColumnOption("Program_Studi"));
            $option->add("Jenjang_Pendidikan", $this->createColumnOption("Jenjang_Pendidikan"));
            $option->add("Jabatan_Fungsional", $this->createColumnOption("Jabatan_Fungsional"));
            $option->add("Kepakaran", $this->createColumnOption("Kepakaran"));
            $option->add("Rumpun_Ilmu", $this->createColumnOption("Rumpun_Ilmu"));
            $option->add("Aktif", $this->createColumnOption("Aktif"));
            $option->add("Validasi", $this->createColumnOption("Validasi"));
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fdosensrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fdosensrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fdosenlist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_dosen", "data-rowtype" => ROWTYPE_ADD]);
...
// Load basic search values
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fdosenlist" data-ew-action="email" data-custom="false" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
		...
		if (@$_COOKIE['dosen_searchpanel'] == 'notactive') {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fdosensrch\" aria-pressed=\"false\">" . $Language->phrase("SearchLink") . "</a>";
		} else {
			// $item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fdosensrch\" aria-pressed=\"false\">" . $Language->phrase("SearchLink") . "</a>";
			$item->Body = "<a class=\"btn btn-default ew-search-toggle active\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fdosensrch\" aria-pressed=\"true\">" . $Language->phrase("SearchLink") . "</a>";
		}
        $item->Visible = true;
