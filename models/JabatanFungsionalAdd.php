 ...
 * Page class
 */
class JabatanFungsionalAdd extends JabatanFungsional
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JabatanFungsionalAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "jabatanfungsionaladd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "jabatanfungsionalview") {
...
// Get upload files
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Nama_Jabatan
        $this->Nama_Jabatan->setDbValueDef($rsnew, $this->Nama_Jabatan->CurrentValue, false);
