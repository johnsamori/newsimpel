 ...
 * Page class
 */
class StatsMonthView extends StatsMonth
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StatsMonthView";
    ...
    // CSS class/style
    public $CurrentPageName = "statsmonthview";
...
// Is modal
        ...
        if (($keyValue = Get("Year") ?? Route("Year")) !== null) {
            ...
            $returnUrl = "statsmonthlist"; // Return to list
        }
        if (($keyValue = Get("Month") ?? Route("Month")) !== null) {
            ...
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("statsmonthlist"); // Return to list page
                        return;
                        ...
                        while (!$this->Recordset->EOF) {
                            if (SameString($this->Year->CurrentValue, $this->Recordset->fields['Year']) && SameString($this->Month->CurrentValue, $this->Recordset->fields['Month'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "statsmonthlist"; // No matching record, return to list
                    } else {
...
// Load recordset
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fstats_monthview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . HtmlEncode(ArrayToJsonAttribute($this->RecKey)) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("statsmonthlist"), "", $this->TableVar, true);
        $pageId = "view";
