 ...
 * Page class
 */
class KelompokPenelitianView extends KelompokPenelitian
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KelompokPenelitianView";
    ...
    // CSS class/style
    public $CurrentPageName = "kelompokpenelitianview";
...
// Is modal
        ...
        if (($keyValue = Get("Id_Kelompok") ?? Route("Id_Kelompok")) !== null) {
            ...
            $returnUrl = "kelompokpenelitianlist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("kelompokpenelitianlist"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "kelompokpenelitianlist"; // No matching record, return to list
                    } else {
...
// Load recordset
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fkelompok_penelitianview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . HtmlEncode(ArrayToJsonAttribute($this->RecKey)) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
