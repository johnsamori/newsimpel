 ...
 * Page class
 */
class StatsMonthDelete extends StatsMonth
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StatsMonthDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "statsmonthdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("statsmonthlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("statsmonthlist"); // Return to list
                return;
            }
        }
