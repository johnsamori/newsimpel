...
class HelpCategories extends DbTable
{
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("helpcategorieslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "helpcategoriesview") {
            return $Language->phrase("View");
        } elseif ($pageName == "helpcategoriesedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "helpcategoriesadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "HelpCategoriesView";
            case Config("API_ADD_ACTION"):
                return "HelpCategoriesAdd";
            case Config("API_EDIT_ACTION"):
                return "HelpCategoriesEdit";
            case Config("API_DELETE_ACTION"):
                return "HelpCategoriesDelete";
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("helpcategoriesdelete");
        }
    }
