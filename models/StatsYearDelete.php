 ...
 * Page class
 */
class StatsYearDelete extends StatsYear
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StatsYearDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "statsyeardelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("statsyearlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("statsyearlist"); // Return to list
                return;
            }
        }
