...
/**
 * Table class for kelompok_penelitian
 */
class KelompokPenelitian extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "kelompok_penelitian";
        $this->Dbid = 'DB';
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "kelompok_penelitian";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("kelompokpenelitianlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "kelompokpenelitianview") {
            return $Language->phrase("View");
        } elseif ($pageName == "kelompokpenelitianedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "kelompokpenelitianadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "KelompokPenelitianView";
            case Config("API_ADD_ACTION"):
                return "KelompokPenelitianAdd";
            case Config("API_EDIT_ACTION"):
                return "KelompokPenelitianEdit";
            case Config("API_DELETE_ACTION"):
                return "KelompokPenelitianDelete";
            case Config("API_LIST_ACTION"):
                return "KelompokPenelitianList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("kelompokpenelitianview", $parm);
        } else {
            $url = $this->keyUrl("kelompokpenelitianview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "kelompokpenelitianadd?" . $parm;
        } else {
            $url = "kelompokpenelitianadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("kelompokpenelitianedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("kelompokpenelitianlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("kelompokpenelitianadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("kelompokpenelitianlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("kelompokpenelitiandelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "KelompokPenelitianList";
    ...
    public function getUserIDSubquery(&$fld, &$masterfld)
    {
        global $UserTable;
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM kelompok_penelitian";
    ...
    public function rowInserting($rsold, &$rsnew)
    {
        ...
        // To cancel, set return value to false
         $rsnew["Id_Kelompok"] = GetNextKodePenelitian(); // mengantisipasi lebih satu user menginput data saat bersamaan
                return true;
    }
    ...
    public function rowRendered()
    {
        ...
        if (CurrentPageID() == "add" && $this->CurrentAction != "F") {
            $this->Id_Kelompok->CurrentValue = GetNextKodePenelitian(); // trik
