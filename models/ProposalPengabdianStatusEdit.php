 ...
 * Page class
 */
class ProposalPengabdianStatusEdit extends ProposalPengabdianStatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProposalPengabdianStatusEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "proposalpengabdianstatusedit";
...
// Is modal
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("id_pengabdian") ?? Key(0) ?? Route(2)) !== null) {
                $this->id_pengabdian->setQueryStringValue($keyValue);
                $this->id_pengabdian->setOldValue($this->id_pengabdian->QueryStringValue);
            } elseif (Post("id_pengabdian") !== null) {
                $this->id_pengabdian->setFormValue(Post("id_pengabdian"));
                $this->id_pengabdian->setOldValue($this->id_pengabdian->FormValue);
            } else {
            ...
            if (Post("action", "") !== "") {
                ...
                $loadByQuery = false;
                if (($keyValue = Get("id_pengabdian") ?? Route("id_pengabdian")) !== null) {
                    $this->id_pengabdian->setQueryStringValue($keyValue);
                    $loadByQuery = true;
                } else {
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("proposalpengabdianstatuslist"); // Return to list page
                        return;
                        ...
                        if ($this->id_pengabdian->CurrentValue != null) {
                            while (!$rs->EOF) {
                                if (SameString($this->id_pengabdian->CurrentValue, $rs->fields['id_pengabdian'])) {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("proposalpengabdianstatuslist"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "proposalpengabdianstatuslist") {
                ...
                if ($this->editRow()) {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "proposalpengabdianstatuslist") {
                            ...
                            $returnUrl = "proposalpengabdianstatuslist"; // Return list page content
                        }
                    }
...
// Get upload files
    ...
    public function renderRow()
    {
        ...
        // id_pengabdian
        $this->id_pengabdian->RowCssClass = $this->IsMobileOrModal ? "row" : "";
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("proposalpengabdianstatuslist"), "", $this->TableVar, true);
        $pageId = "edit";
