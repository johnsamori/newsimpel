...
/**
 * Table class for proposal_pengabdian_status
 */
class ProposalPengabdianStatus extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "proposal_pengabdian_status";
        $this->Dbid = 'DB';
        ...
        // id_pengabdian
        $this->id_pengabdian = new DbField(
            $this, // Table
            'x_id_pengabdian', // Variable name
            'id_pengabdian', // Name
            '`id_pengabdian`', // Expression
            '`id_pengabdian`', // Basic search expression
            3, // Type
            5, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`id_pengabdian`', // Virtual expression
            false, // Is virtual
        ...
        $this->id_pengabdian->InputTextType = "text";
        ...
        $this->id_pengabdian->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->Kelompok_ID->Lookup = new Lookup('Kelompok_ID', 'vproposal_pengabdian', false, 'Id_kelompok', ["Id_kelompok","Nama_Ketua","Judul_Penelitian",""], '', '', [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`Id_kelompok`, ''),'" . ValueSeparator(1, $this->Kelompok_ID) . "',COALESCE(`Nama_Ketua`,''),'" . ValueSeparator(2, $this->Kelompok_ID) . "',COALESCE(`Judul_Penelitian`,''))");
                break;
            case "id-ID":
                $this->Kelompok_ID->Lookup = new Lookup('Kelompok_ID', 'vproposal_pengabdian', false, 'Id_kelompok', ["Id_kelompok","Nama_Ketua","Judul_Penelitian",""], '', '', [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`Id_kelompok`, ''),'" . ValueSeparator(1, $this->Kelompok_ID) . "',COALESCE(`Nama_Ketua`,''),'" . ValueSeparator(2, $this->Kelompok_ID) . "',COALESCE(`Judul_Penelitian`,''))");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->Status->Lookup = new Lookup('Status', 'proposal_pengabdian_status', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
                break;
            case "id-ID":
                $this->Status->Lookup = new Lookup('Status', 'proposal_pengabdian_status', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
                break;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "proposal_pengabdian_status";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($success) {
            ...
            $this->id_pengabdian->setDbValue($conn->lastInsertId());
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($success) {
            if (!isset($rs['id_pengabdian']) && !EmptyValue($this->id_pengabdian->CurrentValue)) {
                $rs['id_pengabdian'] = $this->id_pengabdian->CurrentValue;
            }
        }
        return $success;
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->id_pengabdian->CurrentValue : $this->id_pengabdian->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->id_pengabdian->CurrentValue = $keys[0];
            } else {
    ...
    public function getRecordFilter($row = null, $current = false)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('id_pengabdian', $row) ? $row['id_pengabdian'] : null;
        } else {
            $val = !EmptyValue($this->id_pengabdian->OldValue) && !$current ? $this->id_pengabdian->OldValue : $this->id_pengabdian->CurrentValue;
        }
        if (!is_numeric($val)) {
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("proposalpengabdianstatuslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "proposalpengabdianstatusview") {
            return $Language->phrase("View");
        } elseif ($pageName == "proposalpengabdianstatusedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "proposalpengabdianstatusadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ProposalPengabdianStatusView";
            case Config("API_ADD_ACTION"):
                return "ProposalPengabdianStatusAdd";
            case Config("API_EDIT_ACTION"):
                return "ProposalPengabdianStatusEdit";
            case Config("API_DELETE_ACTION"):
                return "ProposalPengabdianStatusDelete";
            case Config("API_LIST_ACTION"):
                return "ProposalPengabdianStatusList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("proposalpengabdianstatusview", $parm);
        } else {
            $url = $this->keyUrl("proposalpengabdianstatusview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "proposalpengabdianstatusadd?" . $parm;
        } else {
            $url = "proposalpengabdianstatusadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("proposalpengabdianstatusedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("proposalpengabdianstatuslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("proposalpengabdianstatusadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("proposalpengabdianstatuslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("proposalpengabdianstatusdelete");
        }
    }
    ...
    public function keyUrl($url, $parm = "")
    {
        if ($this->id_pengabdian->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->id_pengabdian->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("id_pengabdian") ?? Route("id_pengabdian")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                ...
                $this->id_pengabdian->OldValue = $key;
            }
    ...
    {
        global $Response;
        $listPage = "ProposalPengabdianStatusList";
