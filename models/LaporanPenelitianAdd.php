 ...
 * Page class
 */
class LaporanPenelitianAdd extends LaporanPenelitian
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LaporanPenelitianAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "laporanpenelitianadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "laporanpenelitianview") {
...
// Get upload files
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->Surat_Pernyataan_Kesediaan_Anggota->Visible && !$this->Surat_Pernyataan_Kesediaan_Anggota->Upload->KeepFile) {
            $this->Surat_Pernyataan_Kesediaan_Anggota->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->Surat_Pernyataan_Kesediaan_Anggota->Visible && !$this->Surat_Pernyataan_Kesediaan_Anggota->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->Surat_Pernyataan_Kesediaan_Anggota->Upload->FileName)) {
                ...
                $this->Surat_Pernyataan_Kesediaan_Anggota->setDbValueDef($rsnew, $this->Surat_Pernyataan_Kesediaan_Anggota->Upload->FileName, false);
            }
        }
