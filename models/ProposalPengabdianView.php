 ...
 * Page class
 */
class ProposalPengabdianView extends ProposalPengabdian
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProposalPengabdianView";
    ...
    // CSS class/style
    public $CurrentPageName = "proposalpengabdianview";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("Id_kelompok") ?? Route("Id_kelompok")) !== null) {
            $this->RecKey["Id_kelompok"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("Id_kelompok") ?? Route("Id_kelompok")) !== null) {
            ...
            $returnUrl = "proposalpengabdianlist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("proposalpengabdianlist"); // Return to list page
                        return;
                        ...
                        while (!$this->Recordset->EOF) {
                            if (SameString($this->Id_kelompok->CurrentValue, $this->Recordset->fields['Id_kelompok'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "proposalpengabdianlist"; // No matching record, return to list
                    } else {
...
// Load recordset
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fproposal_pengabdianview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . HtmlEncode(ArrayToJsonAttribute($this->RecKey)) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("proposalpengabdianlist"), "", $this->TableVar, true);
        $pageId = "view";
