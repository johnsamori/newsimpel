 ...
 * Page class
 */
class RumpunIlmuView extends RumpunIlmu
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RumpunIlmuView";
    ...
    // CSS class/style
    public $CurrentPageName = "rumpunilmuview";
...
// Is modal
        ...
        if (($keyValue = Get("no") ?? Route("no")) !== null) {
            ...
            $returnUrl = "rumpunilmulist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("rumpunilmulist"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "rumpunilmulist"; // No matching record, return to list
                    } else {
...
// Load recordset
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="frumpun_ilmuview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . HtmlEncode(ArrayToJsonAttribute($this->RecKey)) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
