 ...
 * Page class
 */
class StatsHourView extends StatsHour
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StatsHourView";
    ...
    // CSS class/style
    public $CurrentPageName = "statshourview";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("Date") ?? Route("Date")) !== null) {
            $this->RecKey["Date"] = $keyValue;
        }
        if (($keyValue = Get("Hour") ?? Route("Hour")) !== null) {
            $this->RecKey["Hour"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("Year") ?? Route("Year")) !== null) {
            ...
            $returnUrl = "statshourlist"; // Return to list
        }
        if (($keyValue = Get("Month") ?? Route("Month")) !== null) {
                ...
                if (!$this->IsModal) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        while (!$this->Recordset->EOF) {
                            if (SameString($this->Year->CurrentValue, $this->Recordset->fields['Year']) && SameString($this->Month->CurrentValue, $this->Recordset->fields['Month']) && SameString($this->Date->CurrentValue, $this->Recordset->fields['Date']) && SameString($this->Hour->CurrentValue, $this->Recordset->fields['Hour'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "statshourlist"; // No matching record, return to list
                    } else {
...
// Load recordset
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fstats_hourview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . HtmlEncode(ArrayToJsonAttribute($this->RecKey)) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
