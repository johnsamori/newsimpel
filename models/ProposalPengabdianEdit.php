 ...
 * Page class
 */
class ProposalPengabdianEdit extends ProposalPengabdian
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProposalPengabdianEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "proposalpengabdianedit";
...
// Is modal
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("proposalpengabdianlist"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "proposalpengabdianlist") {
                ...
                if ($this->editRow()) {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "proposalpengabdianlist") {
                            ...
                            $returnUrl = "proposalpengabdianlist"; // Return list page content
                        }
                    }
...
// Get upload files
    ...
    protected function editRow()
    {
        ...
        // Judul_Penelitian
        $this->Judul_Penelitian->setDbValueDef($rsnew, $this->Judul_Penelitian->CurrentValue, $this->Judul_Penelitian->ReadOnly);
        ...
        // Soft_copy_Proposal
        if ($this->Soft_copy_Proposal->Visible && !$this->Soft_copy_Proposal->ReadOnly && !$this->Soft_copy_Proposal->Upload->KeepFile) {
            $this->Soft_copy_Proposal->Upload->DbValue = $rsold['Soft_copy_Proposal']; // Get original value
        ...
        // Surat_Pernyataan_Tidak_Studi
        if ($this->Surat_Pernyataan_Tidak_Studi->Visible && !$this->Surat_Pernyataan_Tidak_Studi->ReadOnly && !$this->Surat_Pernyataan_Tidak_Studi->Upload->KeepFile) {
            $this->Surat_Pernyataan_Tidak_Studi->Upload->DbValue = $rsold['Surat_Pernyataan_Tidak_Studi']; // Get original value
        ...
        if ($this->Soft_copy_Proposal->Visible && !$this->Soft_copy_Proposal->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->Soft_copy_Proposal->Upload->FileName)) {
                ...
                $this->Soft_copy_Proposal->setDbValueDef($rsnew, $this->Soft_copy_Proposal->Upload->FileName, $this->Soft_copy_Proposal->ReadOnly);
            }
        }
        if ($this->Surat_Pernyataan_Tidak_Studi->Visible && !$this->Surat_Pernyataan_Tidak_Studi->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->Surat_Pernyataan_Tidak_Studi->Upload->FileName)) {
                ...
                $this->Surat_Pernyataan_Tidak_Studi->setDbValueDef($rsnew, $this->Surat_Pernyataan_Tidak_Studi->Upload->FileName, $this->Surat_Pernyataan_Tidak_Studi->ReadOnly);
            }
        }
