 ...
 * Page class
 */
class KelompokPenelitianDelete extends KelompokPenelitian
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KelompokPenelitianDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "kelompokpenelitiandelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("kelompokpenelitianlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("kelompokpenelitianlist"); // Return to list
            return;
        }
