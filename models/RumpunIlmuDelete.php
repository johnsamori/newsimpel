 ...
 * Page class
 */
class RumpunIlmuDelete extends RumpunIlmu
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RumpunIlmuDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "rumpunilmudelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("rumpunilmulist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("rumpunilmulist"); // Return to list
                return;
            }
        }
