 ...
 */
class StatsYear extends DbTable
{
    protected $SqlFrom = "";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "stats_year";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("statsyearlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "statsyearview") {
            return $Language->phrase("View");
        } elseif ($pageName == "statsyearedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "statsyearadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "StatsYearView";
            case Config("API_ADD_ACTION"):
                return "StatsYearAdd";
            case Config("API_EDIT_ACTION"):
                return "StatsYearEdit";
            case Config("API_DELETE_ACTION"):
                return "StatsYearDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("statsyearview", $parm);
        } else {
            $url = $this->keyUrl("statsyearview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("statsyearedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("statsyearlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("statsyearadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("statsyearlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("statsyeardelete");
        }
    }
