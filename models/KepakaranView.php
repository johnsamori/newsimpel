 ...
 * Page class
 */
class KepakaranView extends Kepakaran
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KepakaranView";
    ...
    // CSS class/style
    public $CurrentPageName = "kepakaranview";
...
// Is modal
        ...
        if (($keyValue = Get("no") ?? Route("no")) !== null) {
            ...
            $returnUrl = "kepakaranlist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("kepakaranlist"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "kepakaranlist"; // No matching record, return to list
                    } else {
...
// Load recordset
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("kepakaranlist"), "", $this->TableVar, true);
        $pageId = "view";
