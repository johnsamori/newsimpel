 ...
 * Page class
 */
class StatsYearAdd extends StatsYear
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StatsYearAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "statsyearadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("statsyearlist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "statsyearlist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "statsyearview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "statsyearlist") {
                            ...
                            $returnUrl = "statsyearlist"; // Return list page content
                        }
                    }
