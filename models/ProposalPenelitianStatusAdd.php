 ...
 * Page class
 */
class ProposalPenelitianStatusAdd extends ProposalPenelitianStatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProposalPenelitianStatusAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "proposalpenelitianstatusadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("proposalpenelitianstatuslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "proposalpenelitianstatuslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "proposalpenelitianstatusview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "proposalpenelitianstatuslist") {
                            ...
                            $returnUrl = "proposalpenelitianstatuslist"; // Return list page content
                        }
                    }
...
// Get upload files
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'id_pengabidian' first before field var 'x_id_pengabidian'
        $val = $CurrentForm->hasValue("id_pengabidian") ? $CurrentForm->getValue("id_pengabidian") : $CurrentForm->getValue("x_id_pengabidian");
    }
    ...
    public function renderRow()
    {
        ...
        // id_pengabidian
        $this->id_pengabidian->RowCssClass = $this->IsMobileOrModal ? "row" : "";
