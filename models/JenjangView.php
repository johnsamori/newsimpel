 ...
 * Page class
 */
class JenjangView extends Jenjang
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JenjangView";
    ...
    // CSS class/style
    public $CurrentPageName = "jenjangview";
...
// Is modal
        ...
        if (($keyValue = Get("no") ?? Route("no")) !== null) {
            ...
            $returnUrl = "jenjanglist"; // Return to list
        }
                ...
                if (!$this->IsModal) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        while (!$this->Recordset->EOF) {
                            if (SameString($this->no->CurrentValue, $this->Recordset->fields['no'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "jenjanglist"; // No matching record, return to list
                    } else {
...
// Load recordset
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fjenjangview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . HtmlEncode(ArrayToJsonAttribute($this->RecKey)) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
