...
class Timezone extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->Timezone->Required = true; // Required field
        $this->Timezone->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        ...
        $this->_Default->Nullable = false; // NOT NULL field
        $this->_Default->DataType = DATATYPE_BOOLEAN;
        $this->_Default->TrueValue = "Y";
        $this->_Default->FalseValue = "N";
        switch ($CurrentLanguage) {
            case "en-US":
                $this->_Default->Lookup = new Lookup('Default', 'timezone', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
                break;
            case "id-ID":
                $this->_Default->Lookup = new Lookup('Default', 'timezone', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
                break;
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("timezonelist");
    }
    ...
    {
        global $Language;
        if ($pageName == "timezoneview") {
            return $Language->phrase("View");
        } elseif ($pageName == "timezoneedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "timezoneadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("timezoneview", $parm);
        } else {
            $url = $this->keyUrl("timezoneview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("timezoneedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("timezonelist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("timezoneadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("timezonelist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("timezonedelete");
        }
    }
