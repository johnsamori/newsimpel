 ...
 * Page class
 */
class StatsDateDelete extends StatsDate
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StatsDateDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "statsdatedelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("statsdatelist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("statsdatelist"); // Return to list
                return;
            }
        }
