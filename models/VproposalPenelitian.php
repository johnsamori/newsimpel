...
/**
 * Table class for vproposal_penelitian
 */
class VproposalPenelitian extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "vproposal_penelitian";
        $this->Dbid = 'DB';
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "vproposal_penelitian";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("vproposalpenelitianlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "vproposalpenelitianview") {
            return $Language->phrase("View");
        } elseif ($pageName == "vproposalpenelitianedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "vproposalpenelitianadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VproposalPenelitianView";
            case Config("API_ADD_ACTION"):
                return "VproposalPenelitianAdd";
            case Config("API_EDIT_ACTION"):
                return "VproposalPenelitianEdit";
            case Config("API_DELETE_ACTION"):
                return "VproposalPenelitianDelete";
            case Config("API_LIST_ACTION"):
                return "VproposalPenelitianList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("vproposalpenelitianview", $parm);
        } else {
            $url = $this->keyUrl("vproposalpenelitianview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "vproposalpenelitianadd?" . $parm;
        } else {
            $url = "vproposalpenelitianadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vproposalpenelitianedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vproposalpenelitianlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vproposalpenelitianadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vproposalpenelitianlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("vproposalpenelitiandelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "VproposalPenelitianList";
