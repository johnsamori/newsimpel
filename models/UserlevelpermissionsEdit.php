            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        if ($this->User_Level_ID->CurrentValue != null && $this->Table_Name->CurrentValue != null) {
                            while (!$rs->EOF) {
                                if (SameString($this->User_Level_ID->CurrentValue, $rs->fields['User_Level_ID']) && SameString($this->Table_Name->CurrentValue, $rs->fields['Table_Name'])) {
...
// Get upload files
    ...
    public function renderRow()
    {
        ...
        // User_Level_ID
        $this->User_Level_ID->RowCssClass = $this->IsMobileOrModal ? "row" : "";

        // Table_Name
        $this->Table_Name->RowCssClass = $this->IsMobileOrModal ? "row" : "";
