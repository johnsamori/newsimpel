 ...
 * Page class
 */
class JabatanFungsionalEdit extends JabatanFungsional
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JabatanFungsionalEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "jabatanfungsionaledit";
...
// Is modal
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("jabatanfungsionallist"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "jabatanfungsionallist") {
                ...
                if ($this->editRow()) {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "jabatanfungsionallist") {
                            ...
                            $returnUrl = "jabatanfungsionallist"; // Return list page content
                        }
                    }
...
// Get upload files
    ...
    public function renderRow()
    {
        ...
        // Nama_Jabatan
        $this->Nama_Jabatan->RowCssClass = $this->IsMobileOrModal ? "row" : "";
    ...
    protected function editRow()
    {
        ...
        // Nama_Jabatan
        $this->Nama_Jabatan->setDbValueDef($rsnew, $this->Nama_Jabatan->CurrentValue, $this->Nama_Jabatan->ReadOnly);
