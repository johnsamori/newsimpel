 ...
 * Page class
 */
class ProposalPengabdianList extends ProposalPengabdian
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProposalPengabdianList";
    ...
    public $FormName = "fproposal_pengabdianlist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "proposalpengabdianlist";
    ...
    public function setVisibility()
    {
        ...
        $this->Judul_Penelitian->Visible = false;
    ...
    public function __construct()
    {
        ...
        // Table object (proposal_pengabdian)
        if (!isset($GLOBALS["proposal_pengabdian"]) || get_class($GLOBALS["proposal_pengabdian"]) == PROJECT_NAMESPACE . "proposal_pengabdian") {
            $GLOBALS["proposal_pengabdian"] = &$this;
        }
        ...
        // Initialize URLs
        $this->AddUrl = "proposalpengabdianadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "proposalpengabdiandelete";
        $this->MultiUpdateUrl = "proposalpengabdianupdate";

        // Table name (for backward compatibility only)
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'proposal_pengabdian');
        }
        ...
        if ($url != "") {
            ...
            if ($this->IsModal) { // Show as modal
                ...
                if ($pageName != $this->getListUrl()) { // Not List page => View page
                    ...
                    $result["view"] = $pageName == "proposalpengabdianview"; // If View page, no primary button
                } else { // List page
...
// Is modal
        ...
        if ($this->IsModal) {
            $this->FormName = "fproposal_pengabdiangrid";
        }
		...
		if (@$_COOKIE['proposal_pengabdian_searchpanel'] == 'notactive') {
			RemoveClass($this->SearchPanelClass, "show");
			AppendClass($this->SearchPanelClass, "collapse");
		} elseif (@$_COOKIE['proposal_pengabdian_searchpanel'] == 'active') {
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fproposal_pengabdiansrch");
        }
        ...
        $filterList = Concat($filterList, $this->Warna_Kaver->AdvancedSearch->toJson(), ","); // Field Warna_Kaver
        $filterList = Concat($filterList, $this->Lembar_Pengesahan->AdvancedSearch->toJson(), ","); // Field Lembar_Pengesahan
        $filterList = Concat($filterList, $this->Soft_copy_Proposal->AdvancedSearch->toJson(), ","); // Field Soft_copy_Proposal
        $filterList = Concat($filterList, $this->Surat_Pernyataan_Tidak_Studi->AdvancedSearch->toJson(), ","); // Field Surat_Pernyataan_Tidak_Studi
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fproposal_pengabdiansrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field Warna_Kaver
        $this->Warna_Kaver->AdvancedSearch->SearchValue = @$filter["x_Warna_Kaver"];
        $this->Warna_Kaver->AdvancedSearch->SearchOperator = @$filter["z_Warna_Kaver"];
        $this->Warna_Kaver->AdvancedSearch->SearchCondition = @$filter["v_Warna_Kaver"];
        $this->Warna_Kaver->AdvancedSearch->SearchValue2 = @$filter["y_Warna_Kaver"];
        $this->Warna_Kaver->AdvancedSearch->SearchOperator2 = @$filter["w_Warna_Kaver"];
        $this->Warna_Kaver->AdvancedSearch->save();
        ...
        // Field Soft_copy_Proposal
        $this->Soft_copy_Proposal->AdvancedSearch->SearchValue = @$filter["x_Soft_copy_Proposal"];
        $this->Soft_copy_Proposal->AdvancedSearch->SearchOperator = @$filter["z_Soft_copy_Proposal"];
        $this->Soft_copy_Proposal->AdvancedSearch->SearchCondition = @$filter["v_Soft_copy_Proposal"];
        $this->Soft_copy_Proposal->AdvancedSearch->SearchValue2 = @$filter["y_Soft_copy_Proposal"];
        $this->Soft_copy_Proposal->AdvancedSearch->SearchOperator2 = @$filter["w_Soft_copy_Proposal"];
        $this->Soft_copy_Proposal->AdvancedSearch->save();

        // Field Surat_Pernyataan_Tidak_Studi
        $this->Surat_Pernyataan_Tidak_Studi->AdvancedSearch->SearchValue = @$filter["x_Surat_Pernyataan_Tidak_Studi"];
        $this->Surat_Pernyataan_Tidak_Studi->AdvancedSearch->SearchOperator = @$filter["z_Surat_Pernyataan_Tidak_Studi"];
        $this->Surat_Pernyataan_Tidak_Studi->AdvancedSearch->SearchCondition = @$filter["v_Surat_Pernyataan_Tidak_Studi"];
        $this->Surat_Pernyataan_Tidak_Studi->AdvancedSearch->SearchValue2 = @$filter["y_Surat_Pernyataan_Tidak_Studi"];
        $this->Surat_Pernyataan_Tidak_Studi->AdvancedSearch->SearchOperator2 = @$filter["w_Surat_Pernyataan_Tidak_Studi"];
        $this->Surat_Pernyataan_Tidak_Studi->AdvancedSearch->save();
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        $searchFlds[] = &$this->Warna_Kaver;
        $searchFlds[] = &$this->Lembar_Pengesahan;
        $searchFlds[] = &$this->Soft_copy_Proposal;
        $searchFlds[] = &$this->Surat_Pernyataan_Tidak_Studi;
        $searchFlds[] = &$this->IP;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->Warna_Kaver); // Warna_Kaver
            $this->updateSort($this->Lembar_Pengesahan); // Lembar_Pengesahan
            $this->updateSort($this->Soft_copy_Proposal); // Soft_copy_Proposal
            $this->updateSort($this->Surat_Pernyataan_Tidak_Studi); // Surat_Pernyataan_Tidak_Studi
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->Warna_Kaver->setSort("");
                $this->Lembar_Pengesahan->setSort("");
                $this->Soft_copy_Proposal->setSort("");
                $this->Surat_Pernyataan_Tidak_Studi->setSort("");
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView() && $this->showOptionLink("view")) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"proposal_pengabdian\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($Security->canEdit() && $this->showOptionLink("edit")) {
                if ($this->ModalEdit && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"proposal_pengabdian\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-ask=\"1\" data-btn=\"SaveBtn\">" . $Language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($Security->canAdd() && $this->showOptionLink("add")) {
                if ($this->ModalAdd && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"proposal_pengabdian\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $Language->phrase("CopyLink") . "</a>";
                } else {
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fproposal_pengabdianlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . " " . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fproposal_pengabdianlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . " " . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
			$item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"proposal_pengabdian\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        $item->Body = "<button type=\"button\" class=\"ew-action ew-multi-delete\" title=\"" .
            ...
            HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" form=\"fproposal_pengabdianlist\"" .
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("Warna_Kaver", $this->createColumnOption("Warna_Kaver"));
            $option->add("Lembar_Pengesahan", $this->createColumnOption("Lembar_Pengesahan"));
            $option->add("Soft_copy_Proposal", $this->createColumnOption("Soft_copy_Proposal"));
            $option->add("Surat_Pernyataan_Tidak_Studi", $this->createColumnOption("Surat_Pernyataan_Tidak_Studi"));
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fproposal_pengabdiansrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fproposal_pengabdiansrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fproposal_pengabdianlist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_proposal_pengabdian", "data-rowtype" => ROWTYPE_ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_proposal_pengabdian",
...
// Load basic search values
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fproposal_pengabdianlist" data-ew-action="email" data-custom="false" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
		...
		if (@$_COOKIE['proposal_pengabdian_searchpanel'] == 'notactive') {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fproposal_pengabdiansrch\" aria-pressed=\"false\">" . $Language->phrase("SearchLink") . "</a>";
		} else {
			// $item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fproposal_pengabdiansrch\" aria-pressed=\"false\">" . $Language->phrase("SearchLink") . "</a>";
			$item->Body = "<a class=\"btn btn-default ew-search-toggle active\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fproposal_pengabdiansrch\" aria-pressed=\"true\">" . $Language->phrase("SearchLink") . "</a>";
		}
        $item->Visible = true;
