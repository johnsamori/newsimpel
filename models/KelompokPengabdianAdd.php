 ...
 * Page class
 */
class KelompokPengabdianAdd extends KelompokPengabdian
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KelompokPengabdianAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "kelompokpengabdianadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "kelompokpengabdianview") {
