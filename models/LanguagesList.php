...
// Is modal
		...
		if (@$_COOKIE['languages_searchpanel'] == 'notactive') {
			RemoveClass($this->SearchPanelClass, "show");
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "flanguagessrch");
        }
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->Default_Thousands_Separator); // Default_Thousands_Separator
            $this->updateSort($this->Default_Decimal_Point); // Default_Decimal_Point
            $this->updateSort($this->Default_Currency_Symbol); // Default_Currency_Symbol
            $this->updateSort($this->Default_Money_Thousands_Separator); // Default_Money_Thousands_Separator
            $this->updateSort($this->Default_Money_Decimal_Point); // Default_Money_Decimal_Point
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"languages\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-ask=\"1\" data-btn=\"SaveBtn\">" . $Language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($Security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"languages\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $Language->phrase("CopyLink") . "</a>";
                } else {
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
			$item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"languages\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("Language_Code", $this->createColumnOption("Language_Code"));
            $option->add("Language_Name", $this->createColumnOption("Language_Name"));
            $option->add("Default", $this->createColumnOption("Default"));
            $option->add("Site_Logo", $this->createColumnOption("Site_Logo"));
            $option->add("Site_Title", $this->createColumnOption("Site_Title"));
            $option->add("Default_Thousands_Separator", $this->createColumnOption("Default_Thousands_Separator"));
            $option->add("Default_Decimal_Point", $this->createColumnOption("Default_Decimal_Point"));
            $option->add("Default_Currency_Symbol", $this->createColumnOption("Default_Currency_Symbol"));
            $option->add("Default_Money_Thousands_Separator", $this->createColumnOption("Default_Money_Thousands_Separator"));
            $option->add("Default_Money_Decimal_Point", $this->createColumnOption("Default_Money_Decimal_Point"));
        }
...
// Load basic search values
    ...
    protected function setupSearchOptions()
    {
		...
		if (@$_COOKIE['languages_searchpanel'] == 'notactive') {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"flanguagessrch\" aria-pressed=\"false\">" . $Language->phrase("SearchLink") . "</a>";
		} else {
			// $item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"flanguagessrch\" aria-pressed=\"false\">" . $Language->phrase("SearchLink") . "</a>";
			$item->Body = "<a class=\"btn btn-default ew-search-toggle active\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"flanguagessrch\" aria-pressed=\"true\">" . $Language->phrase("SearchLink") . "</a>";
		}
        $item->Visible = true;
