 ...
 * Page class
 */
class TimezoneAdd extends Timezone
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TimezoneAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "timezoneadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "timezoneview") {
...
// Get upload files
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->Timezone->CurrentValue != "") { // Check field with unique index
            $filter = "(`Timezone` = '" . AdjustSql($this->Timezone->CurrentValue, $this->Dbid) . "')";
