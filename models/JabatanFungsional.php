...
/**
 * Table class for jabatan_fungsional
 */
class JabatanFungsional extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "jabatan_fungsional";
        $this->Dbid = 'DB';
        ...
        // Nama_Jabatan
        $this->Nama_Jabatan = new DbField(
            $this, // Table
            'x_Nama_Jabatan', // Variable name
            'Nama_Jabatan', // Name
            '`Nama_Jabatan`', // Expression
            '`Nama_Jabatan`', // Basic search expression
            200, // Type
            50, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`Nama_Jabatan`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->Nama_Jabatan->InputTextType = "text";
        $this->Nama_Jabatan->Nullable = false; // NOT NULL field
        $this->Nama_Jabatan->Required = true; // Required field
        $this->Nama_Jabatan->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "jabatan_fungsional";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("jabatanfungsionallist");
    }
    ...
    {
        global $Language;
        if ($pageName == "jabatanfungsionalview") {
            return $Language->phrase("View");
        } elseif ($pageName == "jabatanfungsionaledit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "jabatanfungsionaladd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "JabatanFungsionalView";
            case Config("API_ADD_ACTION"):
                return "JabatanFungsionalAdd";
            case Config("API_EDIT_ACTION"):
                return "JabatanFungsionalEdit";
            case Config("API_DELETE_ACTION"):
                return "JabatanFungsionalDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("jabatanfungsionalview", $parm);
        } else {
            $url = $this->keyUrl("jabatanfungsionalview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "jabatanfungsionaladd?" . $parm;
        } else {
            $url = "jabatanfungsionaladd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jabatanfungsionaledit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jabatanfungsionallist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jabatanfungsionaladd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jabatanfungsionallist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jabatanfungsionaldelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "JabatanFungsionalList";
