 ...
 * Page class
 */
class LaporanPenelitianDelete extends LaporanPenelitian
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LaporanPenelitianDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "laporanpenelitiandelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("laporanpenelitianlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("laporanpenelitianlist"); // Return to list
            return;
        }
