 ...
 * Page class
 */
class TimezoneEdit extends Timezone
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TimezoneEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "timezoneedit";
...
// Is modal
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("timezonelist"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "timezonelist") {
                ...
                if ($this->editRow()) {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "timezonelist") {
                            ...
                            $returnUrl = "timezonelist"; // Return list page content
                        }
                    }
...
// Get upload files
    ...
    public function renderRow()
    {
        ...
        // Timezone
        $this->Timezone->RowCssClass = $this->IsMobileOrModal ? "row" : "";
    ...
    protected function editRow()
    {
        ...
        // Check field with unique index (Timezone)
        if ($this->Timezone->CurrentValue != "") {
            $filterChk = "(`Timezone` = '" . AdjustSql($this->Timezone->CurrentValue, $this->Dbid) . "')";
            ...
            if ($rsChk->fetch()) {
                $idxErrMsg = str_replace("%f", $this->Timezone->caption(), $Language->phrase("DupIndex"));
                $idxErrMsg = str_replace("%v", $this->Timezone->CurrentValue, $idxErrMsg);
